...
powershell -Command " Set-Content ..\src\main\java\Api\DeviceDeAssociationApi.java ((get-content ..\src\main\java\Api\DeviceDeAssociationApi.java -raw) -replace 'List<DeviceDeAssociateV3Request>\.class\.getSimpleName\(\)', 'DeviceDeAssociateV3Request.class.getSimpleName()') "
...
git checkout ..\src\test\java\Invokers\HttpClientFactoryMemoryLeakTest.java
