...
**balanceSign** | [**BalanceSignEnum**](#BalanceSignEnum) | Sign for the remaining balance on the account. Returned only when the processor returns this value. Possible values:  |  [optional]
