...
/**
 * API tests for UnifiedCheckoutV1CaptureContextApi
 */
@Ignore
public class UnifiedCheckoutV1CaptureContextApiTest {

    private final UnifiedCheckoutV1CaptureContextApi api = new UnifiedCheckoutV1CaptureContextApi();
     ...
     */
    @Test
    public void generateUnifiedCheckoutV1CaptureContextTest() throws Exception {
        GenerateUnifiedCheckoutV1CaptureContextRequest generateUnifiedCheckoutV1CaptureContextRequest = null;
        String response = api.generateUnifiedCheckoutV1CaptureContext(generateUnifiedCheckoutV1CaptureContextRequest);
