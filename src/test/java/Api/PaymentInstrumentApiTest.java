...
public class PaymentInstrumentApiTest {
    ...
    public void getPaymentInstrumentTest() throws ApiException {
        String paymentInstrumentId = null;
        String profileId = null;
        Tmsv2customersEmbeddedDefaultPaymentInstrument response = api.getPaymentInstrument(paymentInstrumentId, profileId);
    ...
    public void patchPaymentInstrumentTest() throws ApiException {
        ...
        String profileId = null;
        String ifMatch = null;
        Tmsv2customersEmbeddedDefaultPaymentInstrument response = api.patchPaymentInstrument(paymentInstrumentId, patchPaymentInstrumentRequest, profileId, ifMatch);
