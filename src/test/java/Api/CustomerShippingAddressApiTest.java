...
public class CustomerShippingAddressApiTest {
    ...
    public void getCustomerShippingAddressTest() throws Exception {
        ...
        String shippingAddressId = null;
        String profileId = null;
        PostCustomerShippingAddressRequest response = api.getCustomerShippingAddress(customerId, shippingAddressId, profileId);
    ...
    public void patchCustomersShippingAddressTest() throws Exception {
        ...
        String profileId = null;
        String ifMatch = null;
        PatchCustomerShippingAddressRequest response = api.patchCustomersShippingAddress(customerId, shippingAddressId, patchCustomerShippingAddressRequest, profileId, ifMatch);
    ...
    public void postCustomerShippingAddressTest() throws Exception {
        ...
        String profileId = null;
        PostCustomerShippingAddressRequest response = api.postCustomerShippingAddress(customerId, postCustomerShippingAddressRequest, profileId);
