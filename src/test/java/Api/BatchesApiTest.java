...
public class BatchesApiTest {
    ...
    public void getBatchReportTest() throws Exception {
        String batchId = null;
        InlineResponse20010 response = api.getBatchReport(batchId);
    ...
    public void getBatchStatusTest() throws Exception {
        String batchId = null;
        InlineResponse2009 response = api.getBatchStatus(batchId);
    ...
    public void getBatchesListTest() throws Exception {
        ...
        String toDate = null;
        InlineResponse2008 response = api.getBatchesList(offset, limit, fromDate, toDate);
