...
public class BatchesApiTest {
    ...
    public void getBatchReportTest() throws Exception {
        String batchId = null;
        InlineResponse20013 response = api.getBatchReport(batchId);
    ...
    public void getBatchStatusTest() throws Exception {
        String batchId = null;
        InlineResponse20012 response = api.getBatchStatus(batchId);
    ...
    public void getBatchesListTest() throws Exception {
        ...
        String toDate = null;
        InlineResponse20011 response = api.getBatchesList(offset, limit, fromDate, toDate);
