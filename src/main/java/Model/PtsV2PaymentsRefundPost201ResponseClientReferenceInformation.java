...
public class PtsV2PaymentsRefundPost201ResponseClientReferenceInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (submitLocalDateTime != null) sb.append("    submitLocalDateTime: ").append(SENSITIVE_FIELD_PATTERN.matcher("submitLocalDateTime").matches() ? "[REDACTED]" : toIndentedString(submitLocalDateTime)).append("\n");
    if (ownerMerchantId != null) sb.append("    ownerMerchantId: ").append(SENSITIVE_FIELD_PATTERN.matcher("ownerMerchantId").matches() ? "[REDACTED]" : toIndentedString(ownerMerchantId)).append("\n");
