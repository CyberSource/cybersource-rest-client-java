...
public class PtsV2PaymentsPost201ResponsePaymentInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (scheme != null) sb.append("    scheme: ").append(SENSITIVE_FIELD_PATTERN.matcher("scheme").matches() ? "[REDACTED]" : toIndentedString(scheme)).append("\n");
    ...
    if (binCountry != null) sb.append("    binCountry: ").append(SENSITIVE_FIELD_PATTERN.matcher("binCountry").matches() ? "[REDACTED]" : toIndentedString(binCountry)).append("\n");
