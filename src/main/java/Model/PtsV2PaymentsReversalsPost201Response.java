...
public class PtsV2PaymentsReversalsPost201Response {
  ...
  **/
  ...
  public String toString() {
    ...
    if (reversalAmountDetails != null) sb.append("    reversalAmountDetails: ").append(SENSITIVE_FIELD_PATTERN.matcher("reversalAmountDetails").matches() ? "[REDACTED]" : toIndentedString(reversalAmountDetails)).append("\n");
    ...
    if (authorizationInformation != null) sb.append("    authorizationInformation: ").append(SENSITIVE_FIELD_PATTERN.matcher("authorizationInformation").matches() ? "[REDACTED]" : toIndentedString(authorizationInformation)).append("\n");
