...
public class TmsNetworkTokenServices {
  ...
  **/
  ...
  public String toString() {
    ...
    if (paymentCredentials != null) sb.append("    paymentCredentials: ").append(SENSITIVE_FIELD_PATTERN.matcher("paymentCredentials").matches() ? "[REDACTED]" : toIndentedString(paymentCredentials)).append("\n");
    if (synchronousProvisioning != null) sb.append("    synchronousProvisioning: ").append(SENSITIVE_FIELD_PATTERN.matcher("synchronousProvisioning").matches() ? "[REDACTED]" : toIndentedString(synchronousProvisioning)).append("\n");
    ...
    if (americanExpressTokenService != null) sb.append("    americanExpressTokenService: ").append(SENSITIVE_FIELD_PATTERN.matcher("americanExpressTokenService").matches() ? "[REDACTED]" : toIndentedString(americanExpressTokenService)).append("\n");
    sb.append("}");
    return sb.toString();
  }
