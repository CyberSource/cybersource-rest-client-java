...
public class InvoicingV2InvoicesGet200Response {
  ...
  **/
  ...
  public String toString() {
    ...
    if (invoiceHistory != null) sb.append("    invoiceHistory: ").append(SENSITIVE_FIELD_PATTERN.matcher("invoiceHistory").matches() ? "[REDACTED]" : toIndentedString(invoiceHistory)).append("\n");
    sb.append("}");
    return sb.toString();
  }
