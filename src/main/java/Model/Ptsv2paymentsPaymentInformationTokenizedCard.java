...
public class Ptsv2paymentsPaymentInformationTokenizedCard {
  ...
  **/
   ...
   * @return securityCode
  **/
  @ApiModelProperty(value = "Card Verification Number (CVN).  #### Ingenico ePayments Do not include this field when **commerceIndicator=recurring**. **Note** Ingenico ePayments was previously called _Global Collect_. ")
  ...
  **/
  ...
  public String toString() {
    ...
    if (storageMethod != null) sb.append("    storageMethod: ").append(SENSITIVE_FIELD_PATTERN.matcher("storageMethod").matches() ? "[REDACTED]" : toIndentedString(storageMethod)).append("\n");
