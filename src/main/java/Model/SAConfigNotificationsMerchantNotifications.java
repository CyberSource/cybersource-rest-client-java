...
public class SAConfigNotificationsMerchantNotifications {
  ...
  **/
  ...
  public String toString() {
    ...
    if (backofficePostEnabled != null) sb.append("    backofficePostEnabled: ").append(SENSITIVE_FIELD_PATTERN.matcher("backofficePostEnabled").matches() ? "[REDACTED]" : toIndentedString(backofficePostEnabled)).append("\n");
    if (backofficeEmailAddress != null) sb.append("    backofficeEmailAddress: ").append(SENSITIVE_FIELD_PATTERN.matcher("backofficeEmailAddress").matches() ? "[REDACTED]" : toIndentedString(backofficeEmailAddress)).append("\n");
    if (backofficeEmailEnabled != null) sb.append("    backofficeEmailEnabled: ").append(SENSITIVE_FIELD_PATTERN.matcher("backofficeEmailEnabled").matches() ? "[REDACTED]" : toIndentedString(backofficeEmailEnabled)).append("\n");
    if (backofficePostUrl != null) sb.append("    backofficePostUrl: ").append(SENSITIVE_FIELD_PATTERN.matcher("backofficePostUrl").matches() ? "[REDACTED]" : toIndentedString(backofficePostUrl)).append("\n");
    if (cardNumberFormat != null) sb.append("    cardNumberFormat: ").append(SENSITIVE_FIELD_PATTERN.matcher("cardNumberFormat").matches() ? "[REDACTED]" : toIndentedString(cardNumberFormat)).append("\n");
    sb.append("}");
    return sb.toString();
  }
