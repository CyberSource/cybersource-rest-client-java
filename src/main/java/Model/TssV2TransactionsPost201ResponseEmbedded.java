...
public class TssV2TransactionsPost201ResponseEmbedded {
  ...
  **/
  ...
  public String toString() {
    ...
    if (transactionSummaries != null) sb.append("    transactionSummaries: ").append(SENSITIVE_FIELD_PATTERN.matcher("transactionSummaries").matches() ? "[REDACTED]" : toIndentedString(transactionSummaries)).append("\n");
    sb.append("}");
    return sb.toString();
  }
