...
public class PtsV2CreateBillingAgreementPost201ResponseLinks {
  ...
  **/
  ...
  public String toString() {
    ...
    if (updateAgreement != null) sb.append("    updateAgreement: ").append(SENSITIVE_FIELD_PATTERN.matcher("updateAgreement").matches() ? "[REDACTED]" : toIndentedString(updateAgreement)).append("\n");
    if (revokeAgreement != null) sb.append("    revokeAgreement: ").append(SENSITIVE_FIELD_PATTERN.matcher("revokeAgreement").matches() ? "[REDACTED]" : toIndentedString(revokeAgreement)).append("\n");
