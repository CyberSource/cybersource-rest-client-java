...
public class Ptsv2payoutsAggregatorInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (independentSalesOrganizationID != null) sb.append("    independentSalesOrganizationID: ").append(SENSITIVE_FIELD_PATTERN.matcher("independentSalesOrganizationID").matches() ? "[REDACTED]" : toIndentedString(independentSalesOrganizationID)).append("\n");
