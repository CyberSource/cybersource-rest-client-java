...
public class Rbsv1subscriptionsClientReferenceInformationPartner {
  ...
  public Rbsv1subscriptionsClientReferenceInformationPartner developerId(String developerId) {
   ...
   * @return developerId
  **/
  @ApiModelProperty(value = "> This field is ignored when you provide the `subscriptionInformation.originalTransactionId` or update the subscription.  Identifier for the developer that helped integrate a partner solution to CyberSource.  Send this value in all requests that are sent through the partner solutions built by that developer. CyberSource assigns the ID to the developer.  **Note** When you see a developer ID of 999 in reports, the developer ID that was submitted is incorrect. ")
  ...
  public Rbsv1subscriptionsClientReferenceInformationPartner solutionId(String solutionId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Rbsv1subscriptionsClientReferenceInformationPartner rbsv1subscriptionsClientReferenceInformationPartner = (Rbsv1subscriptionsClientReferenceInformationPartner) o;
    return Objects.equals(this.developerId, rbsv1subscriptionsClientReferenceInformationPartner.developerId) &&
        Objects.equals(this.solutionId, rbsv1subscriptionsClientReferenceInformationPartner.solutionId);
  }
