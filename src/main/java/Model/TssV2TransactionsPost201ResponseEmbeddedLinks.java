...
public class TssV2TransactionsPost201ResponseEmbeddedLinks {
  ...
  **/
  ...
  public String toString() {
    ...
    if (transactionDetail != null) sb.append("    transactionDetail: ").append(SENSITIVE_FIELD_PATTERN.matcher("transactionDetail").matches() ? "[REDACTED]" : toIndentedString(transactionDetail)).append("\n");
    sb.append("}");
    return sb.toString();
  }
