...
public class InlineResponse2005EmbeddedLinks {
  ...
  private List<InlineResponse2005EmbeddedLinksReports> reports = null;

  public InlineResponse2005EmbeddedLinks reports(List<InlineResponse2005EmbeddedLinksReports> reports) {
  ...
  public InlineResponse2005EmbeddedLinks addReportsItem(InlineResponse2005EmbeddedLinksReports reportsItem) {
    if (this.reports == null) {
      this.reports = new ArrayList<InlineResponse2005EmbeddedLinksReports>();
    }
  ...
  **/
  ...
  public List<InlineResponse2005EmbeddedLinksReports> getReports() {
    return reports;
  }

  public void setReports(List<InlineResponse2005EmbeddedLinksReports> reports) {
    this.reports = reports;
  }
