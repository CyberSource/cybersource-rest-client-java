...
public class Ptsv2paymentsRecipientInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (beneficiaryId != null) sb.append("    beneficiaryId: ").append(SENSITIVE_FIELD_PATTERN.matcher("beneficiaryId").matches() ? "[REDACTED]" : toIndentedString(beneficiaryId)).append("\n");
    if (beneficiaryName != null) sb.append("    beneficiaryName: ").append(SENSITIVE_FIELD_PATTERN.matcher("beneficiaryName").matches() ? "[REDACTED]" : toIndentedString(beneficiaryName)).append("\n");
    if (beneficiaryAddress != null) sb.append("    beneficiaryAddress: ").append(SENSITIVE_FIELD_PATTERN.matcher("beneficiaryAddress").matches() ? "[REDACTED]" : toIndentedString(beneficiaryAddress)).append("\n");
    ...
    if (taxIdNumber != null) sb.append("    taxIdNumber: ").append(SENSITIVE_FIELD_PATTERN.matcher("taxIdNumber").matches() ? "[REDACTED]" : toIndentedString(taxIdNumber)).append("\n");
    sb.append("}");
    return sb.toString();
  }
