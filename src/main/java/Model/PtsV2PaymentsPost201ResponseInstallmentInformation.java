...
public class PtsV2PaymentsPost201ResponseInstallmentInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (minimumTotalCount != null) sb.append("    minimumTotalCount: ").append(SENSITIVE_FIELD_PATTERN.matcher("minimumTotalCount").matches() ? "[REDACTED]" : toIndentedString(minimumTotalCount)).append("\n");
