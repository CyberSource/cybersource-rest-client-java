...
public class SaveSymEgressKey {
  ...
  **/
  ...
  public String toString() {
    ...
    if (clientRequestAction != null) sb.append("    clientRequestAction: ").append(SENSITIVE_FIELD_PATTERN.matcher("clientRequestAction").matches() ? "[REDACTED]" : toIndentedString(clientRequestAction)).append("\n");
