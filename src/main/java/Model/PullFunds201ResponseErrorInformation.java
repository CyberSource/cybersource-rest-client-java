...
import Model.PullFunds201ResponseErrorInformationDetails;
...
public class PullFunds201ResponseErrorInformation {
  ...
  private List<PullFunds201ResponseErrorInformationDetails> details = null;
   ...
   * @return reason
  **/
  @ApiModelProperty(value = "The reason of the status.  Possible values: - CONTACT_PROCESSOR - INVALID_MERCHANT_CONFIGURATION - STOLEN_LOST_CARD - PROCESSOR_DECLINED - PARTIAL_APPROVAL - PAYMENT_REFUSED - INVALID_ACCOUNT - ISSUER_UNAVAILABLE - INSUFFICIENT_FUND - EXPIRED_CARD - INVALID_PIN - UNAUTHORIZED_CARD - EXCEEDS_CREDIT_LIMIT - DEBIT_CARD_USAGE_LIMIT_EXCEEDED - CVN_NOT_MATCH - DUPLICATE_REQUEST - GENERAL_DECLINE - BLACKLISTED_CUSTOMER - GATEWAY_TIMEOUT - INVALID_DATA - SYSTEM_ERROR - SERVICE_UNAVAILABLE - PROCESSOR_TIMEOUT - PAYMENT_REJECTED - PULL_PAYMENT_REFUSED ")
  ...
  **/
  ...
  public PullFunds201ResponseErrorInformation addDetailsItem(PullFunds201ResponseErrorInformationDetails detailsItem) {
    if (this.details == null) {
      this.details = new ArrayList<PullFunds201ResponseErrorInformationDetails>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PullFunds201ResponseErrorInformation pullFunds201ResponseErrorInformation = (PullFunds201ResponseErrorInformation) o;
    return Objects.equals(this.reason, pullFunds201ResponseErrorInformation.reason) &&
        Objects.equals(this.message, pullFunds201ResponseErrorInformation.message) &&
        Objects.equals(this.details, pullFunds201ResponseErrorInformation.details);
  }
