...
public class Ptsv2paymentsProcessingInformationJapanPaymentOptions {
  ...
  **/
  ...
  public String toString() {
    ...
    if (preapprovalType != null) sb.append("    preapprovalType: ").append(SENSITIVE_FIELD_PATTERN.matcher("preapprovalType").matches() ? "[REDACTED]" : toIndentedString(preapprovalType)).append("\n");
    ...
    if (businessNameKatakana != null) sb.append("    businessNameKatakana: ").append(SENSITIVE_FIELD_PATTERN.matcher("businessNameKatakana").matches() ? "[REDACTED]" : toIndentedString(businessNameKatakana)).append("\n");
    if (jis2TrackData != null) sb.append("    jis2TrackData: ").append(SENSITIVE_FIELD_PATTERN.matcher("jis2TrackData").matches() ? "[REDACTED]" : toIndentedString(jis2TrackData)).append("\n");
    if (businessNameAlphaNumeric != null) sb.append("    businessNameAlphaNumeric: ").append(SENSITIVE_FIELD_PATTERN.matcher("businessNameAlphaNumeric").matches() ? "[REDACTED]" : toIndentedString(businessNameAlphaNumeric)).append("\n");
    sb.append("}");
    return sb.toString();
  }
