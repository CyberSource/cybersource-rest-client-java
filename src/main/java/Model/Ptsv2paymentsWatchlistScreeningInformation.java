...
public class Ptsv2paymentsWatchlistScreeningInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (addressOperator != null) sb.append("    addressOperator: ").append(SENSITIVE_FIELD_PATTERN.matcher("addressOperator").matches() ? "[REDACTED]" : toIndentedString(addressOperator)).append("\n");
    if (weights != null) sb.append("    weights: ").append(SENSITIVE_FIELD_PATTERN.matcher("weights").matches() ? "[REDACTED]" : toIndentedString(weights)).append("\n");
    if (sanctionLists != null) sb.append("    sanctionLists: ").append(SENSITIVE_FIELD_PATTERN.matcher("sanctionLists").matches() ? "[REDACTED]" : toIndentedString(sanctionLists)).append("\n");
    if (proceedOnMatch != null) sb.append("    proceedOnMatch: ").append(SENSITIVE_FIELD_PATTERN.matcher("proceedOnMatch").matches() ? "[REDACTED]" : toIndentedString(proceedOnMatch)).append("\n");
    sb.append("}");
    return sb.toString();
  }
