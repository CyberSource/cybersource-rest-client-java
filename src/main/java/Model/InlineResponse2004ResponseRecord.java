...
import Model.InlineResponse2004ResponseRecordAdditionalUpdates;
...
public class InlineResponse2004ResponseRecord {
  ...
  public InlineResponse2004ResponseRecord response(String response) {
  ...
  **/
  ...
  public InlineResponse2004ResponseRecord reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse2004ResponseRecord token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse2004ResponseRecord instrumentIdentifierId(String instrumentIdentifierId) {
  ...
  **/
  ...
  public InlineResponse2004ResponseRecord cardNumber(String cardNumber) {
  ...
  **/
  ...
  public InlineResponse2004ResponseRecord cardExpiryMonth(String cardExpiryMonth) {
  ...
  **/
  ...
  public InlineResponse2004ResponseRecord cardExpiryYear(String cardExpiryYear) {
  ...
  **/
  ...
  public InlineResponse2004ResponseRecord cardType(String cardType) {
  ...
  **/
  ...
  public InlineResponse2004ResponseRecord additionalUpdates(List<InlineResponse2004ResponseRecordAdditionalUpdates> additionalUpdates) {
    this.additionalUpdates = additionalUpdates;
    return this;
  }

  public InlineResponse2004ResponseRecord addAdditionalUpdatesItem(InlineResponse2004ResponseRecordAdditionalUpdates additionalUpdatesItem) {
    if (this.additionalUpdates == null) {
      this.additionalUpdates = new ArrayList<InlineResponse2004ResponseRecordAdditionalUpdates>();
    }
  ...
  **/
  ...
  public void setAdditionalUpdates(List<InlineResponse2004ResponseRecordAdditionalUpdates> additionalUpdates) {
    this.additionalUpdates = additionalUpdates;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InlineResponse2004ResponseRecord inlineResponse2004ResponseRecord = (InlineResponse2004ResponseRecord) o;
    return Objects.equals(this.response, inlineResponse2004ResponseRecord.response) &&
        Objects.equals(this.reason, inlineResponse2004ResponseRecord.reason) &&
        Objects.equals(this.token, inlineResponse2004ResponseRecord.token) &&
        Objects.equals(this.instrumentIdentifierId, inlineResponse2004ResponseRecord.instrumentIdentifierId) &&
        Objects.equals(this.instrumentIdentifierCreated, inlineResponse2004ResponseRecord.instrumentIdentifierCreated) &&
        Objects.equals(this.cardNumber, inlineResponse2004ResponseRecord.cardNumber) &&
        Objects.equals(this.cardExpiryMonth, inlineResponse2004ResponseRecord.cardExpiryMonth) &&
        Objects.equals(this.cardExpiryYear, inlineResponse2004ResponseRecord.cardExpiryYear) &&
        Objects.equals(this.cardType, inlineResponse2004ResponseRecord.cardType) &&
        Objects.equals(this.additionalUpdates, inlineResponse2004ResponseRecord.additionalUpdates);
  }
