...
public class InlineResponse20012EmbeddedBatches {
  ...
  **/
  ...
  public String toString() {
    ...
    if (batchModifiedDate != null) sb.append("    batchModifiedDate: ").append(SENSITIVE_FIELD_PATTERN.matcher("batchModifiedDate").matches() ? "[REDACTED]" : toIndentedString(batchModifiedDate)).append("\n");
    ...
    if (tokenSource != null) sb.append("    tokenSource: ").append(SENSITIVE_FIELD_PATTERN.matcher("tokenSource").matches() ? "[REDACTED]" : toIndentedString(tokenSource)).append("\n");
