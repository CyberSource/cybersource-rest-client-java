...
public class PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresent {
  ...
  private Map<String, PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresentProcessors> processors = null;

  @SerializedName("enableTerminalIdLookup")
  private Boolean enableTerminalIdLookup = null;

  public PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresent processors(Map<String, PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresentProcessors> processors) {
  ...
  public PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresent putProcessorsItem(String key, PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresentProcessors processorsItem) {
    if (this.processors == null) {
      this.processors = new HashMap<String, PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresentProcessors>();
    }
  ...
  **/
  ...
  public Map<String, PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresentProcessors> getProcessors() {
    return processors;
  }

  public void setProcessors(Map<String, PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresentProcessors> processors) {
    this.processors = processors;
  }
