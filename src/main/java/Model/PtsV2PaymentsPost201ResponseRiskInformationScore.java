...
public class PtsV2PaymentsPost201ResponseRiskInformationScore {
  ...
  **/
  ...
  public String toString() {
    ...
    if (factorCodes != null) sb.append("    factorCodes: ").append(SENSITIVE_FIELD_PATTERN.matcher("factorCodes").matches() ? "[REDACTED]" : toIndentedString(factorCodes)).append("\n");
    if (modelUsed != null) sb.append("    modelUsed: ").append(SENSITIVE_FIELD_PATTERN.matcher("modelUsed").matches() ? "[REDACTED]" : toIndentedString(modelUsed)).append("\n");
