...
public class Ptsv2paymentsTravelInformationLodgingRoom {
  ...
  **/
  ...
  public String toString() {
    ...
    if (dailyRate != null) sb.append("    dailyRate: ").append(SENSITIVE_FIELD_PATTERN.matcher("dailyRate").matches() ? "[REDACTED]" : toIndentedString(dailyRate)).append("\n");
    if (numberOfNights != null) sb.append("    numberOfNights: ").append(SENSITIVE_FIELD_PATTERN.matcher("numberOfNights").matches() ? "[REDACTED]" : toIndentedString(numberOfNights)).append("\n");
    sb.append("}");
    return sb.toString();
  }
