...
public class InlineResponseDefaultLinks {
  ...
  **/
  ...
  public String toString() {
    ...
    if (documentation != null) sb.append("    documentation: ").append(SENSITIVE_FIELD_PATTERN.matcher("documentation").matches() ? "[REDACTED]" : toIndentedString(documentation)).append("\n");
