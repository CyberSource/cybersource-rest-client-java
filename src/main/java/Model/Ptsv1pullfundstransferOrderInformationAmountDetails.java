...
public class Ptsv1pullfundstransferOrderInformationAmountDetails {
  ...
  **/
  ...
  public String toString() {
    ...
    if (foreignExchangeFee != null) sb.append("    foreignExchangeFee: ").append(SENSITIVE_FIELD_PATTERN.matcher("foreignExchangeFee").matches() ? "[REDACTED]" : toIndentedString(foreignExchangeFee)).append("\n");
