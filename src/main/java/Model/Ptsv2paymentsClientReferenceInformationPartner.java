...
public class Ptsv2paymentsClientReferenceInformationPartner {
  ...
  **/
  ...
  public String toString() {
    ...
    if (thirdPartyCertificationNumber != null) sb.append("    thirdPartyCertificationNumber: ").append(SENSITIVE_FIELD_PATTERN.matcher("thirdPartyCertificationNumber").matches() ? "[REDACTED]" : toIndentedString(thirdPartyCertificationNumber)).append("\n");
    sb.append("}");
    return sb.toString();
  }
