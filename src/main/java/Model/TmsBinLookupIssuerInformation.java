...
public class TmsBinLookupIssuerInformation {
  ...
  **/
   ...
   * @return binLength
  **/
  @ApiModelProperty(value = "This field contains the length of the BIN. In some cases, this field may be absent if we do not receive accurate information from the network source. ")
  ...
  **/
  ...
  public String toString() {
    ...
    if (binLength != null) sb.append("    binLength: ").append(SENSITIVE_FIELD_PATTERN.matcher("binLength").matches() ? "[REDACTED]" : toIndentedString(binLength)).append("\n");
    if (accountPrefix != null) sb.append("    accountPrefix: ").append(SENSITIVE_FIELD_PATTERN.matcher("accountPrefix").matches() ? "[REDACTED]" : toIndentedString(accountPrefix)).append("\n");
