...
public class TssV2TransactionsGet200ResponsePaymentInformationAccountFeatures {
  ...
  **/
  ...
  public String toString() {
    ...
    if (previousBalanceAmount != null) sb.append("    previousBalanceAmount: ").append(SENSITIVE_FIELD_PATTERN.matcher("previousBalanceAmount").matches() ? "[REDACTED]" : toIndentedString(previousBalanceAmount)).append("\n");
