...
public class Ptsv2payoutsProcessingInformationPayoutsOptions {
  ...
  **/
  ...
  public String toString() {
    ...
    if (accountFundingReferenceId != null) sb.append("    accountFundingReferenceId: ").append(SENSITIVE_FIELD_PATTERN.matcher("accountFundingReferenceId").matches() ? "[REDACTED]" : toIndentedString(accountFundingReferenceId)).append("\n");
    if (deferredDateTime != null) sb.append("    deferredDateTime: ").append(SENSITIVE_FIELD_PATTERN.matcher("deferredDateTime").matches() ? "[REDACTED]" : toIndentedString(deferredDateTime)).append("\n");
    sb.append("}");
    return sb.toString();
  }
