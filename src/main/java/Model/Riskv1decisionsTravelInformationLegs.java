...
public class Riskv1decisionsTravelInformationLegs {
  ...
  **/
  ...
  public String toString() {
    ...
    if (origination != null) sb.append("    origination: ").append(SENSITIVE_FIELD_PATTERN.matcher("origination").matches() ? "[REDACTED]" : toIndentedString(origination)).append("\n");
    if (destination != null) sb.append("    destination: ").append(SENSITIVE_FIELD_PATTERN.matcher("destination").matches() ? "[REDACTED]" : toIndentedString(destination)).append("\n");
