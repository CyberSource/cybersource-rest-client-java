...
public class TmsBusinessInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (businessIdentificationType != null) sb.append("    businessIdentificationType: ").append(SENSITIVE_FIELD_PATTERN.matcher("businessIdentificationType").matches() ? "[REDACTED]" : toIndentedString(businessIdentificationType)).append("\n");
    if (businessIdentificationValue != null) sb.append("    businessIdentificationValue: ").append(SENSITIVE_FIELD_PATTERN.matcher("businessIdentificationValue").matches() ? "[REDACTED]" : toIndentedString(businessIdentificationValue)).append("\n");
