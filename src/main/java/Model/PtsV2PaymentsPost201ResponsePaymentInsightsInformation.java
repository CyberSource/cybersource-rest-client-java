...
public class PtsV2PaymentsPost201ResponsePaymentInsightsInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (responseInsights != null) sb.append("    responseInsights: ").append(SENSITIVE_FIELD_PATTERN.matcher("responseInsights").matches() ? "[REDACTED]" : toIndentedString(responseInsights)).append("\n");
    if (orchestration != null) sb.append("    orchestration: ").append(SENSITIVE_FIELD_PATTERN.matcher("orchestration").matches() ? "[REDACTED]" : toIndentedString(orchestration)).append("\n");
    sb.append("}");
    return sb.toString();
  }
