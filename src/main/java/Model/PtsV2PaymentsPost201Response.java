...
public class PtsV2PaymentsPost201Response {
  ...
  **/
  ...
  public String toString() {
    ...
    if (embeddedActions != null) sb.append("    embeddedActions: ").append(SENSITIVE_FIELD_PATTERN.matcher("embeddedActions").matches() ? "[REDACTED]" : toIndentedString(embeddedActions)).append("\n");
