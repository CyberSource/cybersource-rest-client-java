...
public class Tssv2transactionsemvTagDetailsEmvDetailsList {
  ...
  **/
  ...
  public String toString() {
    ...
    if (emvRequestCombinedTags != null) sb.append("    emvRequestCombinedTags: ").append(SENSITIVE_FIELD_PATTERN.matcher("emvRequestCombinedTags").matches() ? "[REDACTED]" : toIndentedString(emvRequestCombinedTags)).append("\n");
    sb.append("}");
    return sb.toString();
  }
