...
public class TssV2TransactionsGet200ResponseRiskInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (passiveProfile != null) sb.append("    passiveProfile: ").append(SENSITIVE_FIELD_PATTERN.matcher("passiveProfile").matches() ? "[REDACTED]" : toIndentedString(passiveProfile)).append("\n");
    if (passiveRules != null) sb.append("    passiveRules: ").append(SENSITIVE_FIELD_PATTERN.matcher("passiveRules").matches() ? "[REDACTED]" : toIndentedString(passiveRules)).append("\n");
