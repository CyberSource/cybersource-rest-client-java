...
public class SAConfigPaymentMethods {
  ...
  **/
  ...
  public String toString() {
    ...
    if (enabledPaymentMethods != null) sb.append("    enabledPaymentMethods: ").append(SENSITIVE_FIELD_PATTERN.matcher("enabledPaymentMethods").matches() ? "[REDACTED]" : toIndentedString(enabledPaymentMethods)).append("\n");
    sb.append("}");
    return sb.toString();
  }
