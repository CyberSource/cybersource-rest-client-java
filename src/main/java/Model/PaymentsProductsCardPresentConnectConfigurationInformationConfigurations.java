...
public class PaymentsProductsCardPresentConnectConfigurationInformationConfigurations {
  ...
  **/
  ...
  public String toString() {
    ...
    if (partnerSolutionIdentifier != null) sb.append("    partnerSolutionIdentifier: ").append(SENSITIVE_FIELD_PATTERN.matcher("partnerSolutionIdentifier").matches() ? "[REDACTED]" : toIndentedString(partnerSolutionIdentifier)).append("\n");
    sb.append("}");
    return sb.toString();
  }
