...
public class Riskv1exportcomplianceinquiriesOrderInformation {
  ...
  private List<Riskv1exportcomplianceinquiriesOrderInformationLineItems> lineItems = null;
  ...
  **/
  ...
  public Riskv1exportcomplianceinquiriesOrderInformation lineItems(List<Riskv1exportcomplianceinquiriesOrderInformationLineItems> lineItems) {
  ...
  public Riskv1exportcomplianceinquiriesOrderInformation addLineItemsItem(Riskv1exportcomplianceinquiriesOrderInformationLineItems lineItemsItem) {
    if (this.lineItems == null) {
      this.lineItems = new ArrayList<Riskv1exportcomplianceinquiriesOrderInformationLineItems>();
    }
  ...
  **/
  @ApiModelProperty(value = "")
  public List<Riskv1exportcomplianceinquiriesOrderInformationLineItems> getLineItems() {
    return lineItems;
  }

  public void setLineItems(List<Riskv1exportcomplianceinquiriesOrderInformationLineItems> lineItems) {
    this.lineItems = lineItems;
  }
