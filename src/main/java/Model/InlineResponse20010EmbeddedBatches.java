...
import Model.InlineResponse20010EmbeddedLinks;
...
public class InlineResponse20010EmbeddedBatches {
  @SerializedName("_links")
  private InlineResponse20010EmbeddedLinks links = null;
  ...
  public InlineResponse20010EmbeddedBatches links(InlineResponse20010EmbeddedLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20010EmbeddedLinks getLinks() {
    return links;
  }

  public void setLinks(InlineResponse20010EmbeddedLinks links) {
    this.links = links;
  }

  public InlineResponse20010EmbeddedBatches batchId(String batchId) {
  ...
  **/
  ...
  public InlineResponse20010EmbeddedBatches batchCreatedDate(String batchCreatedDate) {
  ...
  **/
  ...
  public InlineResponse20010EmbeddedBatches batchModifiedDate(String batchModifiedDate) {
  ...
  **/
  ...
  public InlineResponse20010EmbeddedBatches batchSource(String batchSource) {
  ...
  **/
  ...
  public InlineResponse20010EmbeddedBatches tokenSource(String tokenSource) {
  ...
  **/
  ...
  public InlineResponse20010EmbeddedBatches merchantReference(String merchantReference) {
  ...
  **/
  ...
  public InlineResponse20010EmbeddedBatches batchCaEndpoints(List<String> batchCaEndpoints) {
    this.batchCaEndpoints = batchCaEndpoints;
    return this;
  }

  public InlineResponse20010EmbeddedBatches addBatchCaEndpointsItem(String batchCaEndpointsItem) {
  ...
  **/
  ...
  public InlineResponse20010EmbeddedBatches status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20010EmbeddedBatches totals(InlineResponse20010EmbeddedTotals totals) {
    this.totals = totals;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InlineResponse20010EmbeddedBatches inlineResponse20010EmbeddedBatches = (InlineResponse20010EmbeddedBatches) o;
    return Objects.equals(this.links, inlineResponse20010EmbeddedBatches.links) &&
        Objects.equals(this.batchId, inlineResponse20010EmbeddedBatches.batchId) &&
        Objects.equals(this.batchCreatedDate, inlineResponse20010EmbeddedBatches.batchCreatedDate) &&
        Objects.equals(this.batchModifiedDate, inlineResponse20010EmbeddedBatches.batchModifiedDate) &&
        Objects.equals(this.batchSource, inlineResponse20010EmbeddedBatches.batchSource) &&
        Objects.equals(this.tokenSource, inlineResponse20010EmbeddedBatches.tokenSource) &&
        Objects.equals(this.merchantReference, inlineResponse20010EmbeddedBatches.merchantReference) &&
        Objects.equals(this.batchCaEndpoints, inlineResponse20010EmbeddedBatches.batchCaEndpoints) &&
        Objects.equals(this.status, inlineResponse20010EmbeddedBatches.status) &&
        Objects.equals(this.totals, inlineResponse20010EmbeddedBatches.totals);
  }
