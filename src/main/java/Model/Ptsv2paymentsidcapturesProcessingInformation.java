...
public class Ptsv2paymentsidcapturesProcessingInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (digitalServiceIndicator != null) sb.append("    digitalServiceIndicator: ").append(SENSITIVE_FIELD_PATTERN.matcher("digitalServiceIndicator").matches() ? "[REDACTED]" : toIndentedString(digitalServiceIndicator)).append("\n");
