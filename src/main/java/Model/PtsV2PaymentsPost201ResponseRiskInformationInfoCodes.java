...
public class PtsV2PaymentsPost201ResponseRiskInformationInfoCodes {
  ...
  **/
  ...
  public String toString() {
    ...
    if (customerList != null) sb.append("    customerList: ").append(SENSITIVE_FIELD_PATTERN.matcher("customerList").matches() ? "[REDACTED]" : toIndentedString(customerList)).append("\n");
    if (deviceBehavior != null) sb.append("    deviceBehavior: ").append(SENSITIVE_FIELD_PATTERN.matcher("deviceBehavior").matches() ? "[REDACTED]" : toIndentedString(deviceBehavior)).append("\n");
    if (identityChange != null) sb.append("    identityChange: ").append(SENSITIVE_FIELD_PATTERN.matcher("identityChange").matches() ? "[REDACTED]" : toIndentedString(identityChange)).append("\n");
    if (internet != null) sb.append("    internet: ").append(SENSITIVE_FIELD_PATTERN.matcher("internet").matches() ? "[REDACTED]" : toIndentedString(internet)).append("\n");
    ...
    if (suspicious != null) sb.append("    suspicious: ").append(SENSITIVE_FIELD_PATTERN.matcher("suspicious").matches() ? "[REDACTED]" : toIndentedString(suspicious)).append("\n");
    if (globalVelocity != null) sb.append("    globalVelocity: ").append(SENSITIVE_FIELD_PATTERN.matcher("globalVelocity").matches() ? "[REDACTED]" : toIndentedString(globalVelocity)).append("\n");
    sb.append("}");
    return sb.toString();
  }
