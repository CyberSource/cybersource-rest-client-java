...
public class ReportingV3ReportsGet200ResponseLink {
  ...
  **/
  ...
  public String toString() {
    ...
    if (reportDownload != null) sb.append("    reportDownload: ").append(SENSITIVE_FIELD_PATTERN.matcher("reportDownload").matches() ? "[REDACTED]" : toIndentedString(reportDownload)).append("\n");
    sb.append("}");
    return sb.toString();
  }
