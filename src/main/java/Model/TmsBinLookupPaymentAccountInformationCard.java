...
public class TmsBinLookupPaymentAccountInformationCard {
  ...
  **/
  ...
  public String toString() {
    ...
    if (maxLength != null) sb.append("    maxLength: ").append(SENSITIVE_FIELD_PATTERN.matcher("maxLength").matches() ? "[REDACTED]" : toIndentedString(maxLength)).append("\n");
    if (credentialType != null) sb.append("    credentialType: ").append(SENSITIVE_FIELD_PATTERN.matcher("credentialType").matches() ? "[REDACTED]" : toIndentedString(credentialType)).append("\n");
    if (brands != null) sb.append("    brands: ").append(SENSITIVE_FIELD_PATTERN.matcher("brands").matches() ? "[REDACTED]" : toIndentedString(brands)).append("\n");
    sb.append("}");
    return sb.toString();
  }
