...
public class RiskV1DecisionsPost400Response {
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(value = "The status of the submitted transaction.  Possible values:  - `INVALID_REQUEST`  - `DECLINED` ")
   ...
   * @return reason
  **/
  @ApiModelProperty(value = "The reason of the status.  Possible values:  - `MISSING_FIELD`  - `INVALID_DATA`  - `INVALID_ACCOUNT` ")
