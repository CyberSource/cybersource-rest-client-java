...
public class PtsV1TransactionBatchesGet200Response {
  ...
  **/
  ...
  public String toString() {
    ...
    if (transactionBatches != null) sb.append("    transactionBatches: ").append(SENSITIVE_FIELD_PATTERN.matcher("transactionBatches").matches() ? "[REDACTED]" : toIndentedString(transactionBatches)).append("\n");
