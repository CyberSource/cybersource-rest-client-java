...
public class ECheckConfigFeatures {
  ...
  **/
  ...
  public String toString() {
    ...
    if (accountValidationService != null) sb.append("    accountValidationService: ").append(SENSITIVE_FIELD_PATTERN.matcher("accountValidationService").matches() ? "[REDACTED]" : toIndentedString(accountValidationService)).append("\n");
    sb.append("}");
    return sb.toString();
  }
