...
public class PblPaymentLinksAllGet200Response {
  ...
  **/
  ...
  public String toString() {
    ...
    if (totalLinks != null) sb.append("    totalLinks: ").append(SENSITIVE_FIELD_PATTERN.matcher("totalLinks").matches() ? "[REDACTED]" : toIndentedString(totalLinks)).append("\n");
    if (sdkLinks != null) sb.append("    sdkLinks: ").append(SENSITIVE_FIELD_PATTERN.matcher("sdkLinks").matches() ? "[REDACTED]" : toIndentedString(sdkLinks)).append("\n");
    sb.append("}");
    return sb.toString();
  }
