...
public class PayerAuthConfigCardTypesJCBJSecure {
  ...
  **/
  ...
  public String toString() {
    ...
    if (securePasswordForJCB != null) sb.append("    securePasswordForJCB: ").append(SENSITIVE_FIELD_PATTERN.matcher("securePasswordForJCB").matches() ? "[REDACTED]" : toIndentedString(securePasswordForJCB)).append("\n");
