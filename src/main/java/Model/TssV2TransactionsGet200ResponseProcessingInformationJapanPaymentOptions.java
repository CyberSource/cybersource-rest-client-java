...
public class TssV2TransactionsGet200ResponseProcessingInformationJapanPaymentOptions {
  ...
  **/
  ...
  public String toString() {
    ...
    if (businessNameEnglish != null) sb.append("    businessNameEnglish: ").append(SENSITIVE_FIELD_PATTERN.matcher("businessNameEnglish").matches() ? "[REDACTED]" : toIndentedString(businessNameEnglish)).append("\n");
