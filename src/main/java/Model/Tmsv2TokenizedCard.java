...
public class Tmsv2TokenizedCard {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, id, object, accountReferenceId, consumerId, createInstrumentIdentifier, source, state, reason, number, cryptogram, securityCode, eci, requestorId, enrollmentId, tokenReferenceId, paymentAccountReference, card, passcode, metadata);
  }
