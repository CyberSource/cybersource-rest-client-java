...
public class Notificationsubscriptionsv2webhooksSecurityPolicyConfig {
  ...
  **/
  ...
  public String toString() {
    ...
    if (oAuthURL != null) sb.append("    oAuthURL: ").append(SENSITIVE_FIELD_PATTERN.matcher("oAuthURL").matches() ? "[REDACTED]" : toIndentedString(oAuthURL)).append("\n");
    if (oAuthTokenType != null) sb.append("    oAuthTokenType: ").append(SENSITIVE_FIELD_PATTERN.matcher("oAuthTokenType").matches() ? "[REDACTED]" : toIndentedString(oAuthTokenType)).append("\n");
    if (additionalConfig != null) sb.append("    additionalConfig: ").append(SENSITIVE_FIELD_PATTERN.matcher("additionalConfig").matches() ? "[REDACTED]" : toIndentedString(additionalConfig)).append("\n");
    sb.append("}");
    return sb.toString();
  }
