...
import Model.RiskAddressVerificationInformationBarCode;
import Model.RiskAddressVerificationInformationStandardAddress;
...
public class RiskAddressVerificationInformation {
  @SerializedName("addressType")
  private String addressType = null;

  @SerializedName("barCode")
  private RiskAddressVerificationInformationBarCode barCode = null;
  ...
  private RiskAddressVerificationInformationStandardAddress standardAddress = null;

  public RiskAddressVerificationInformation addressType(String addressType) {
  ...
  **/
  ...
  public RiskAddressVerificationInformation barCode(RiskAddressVerificationInformationBarCode barCode) {
  ...
  **/
  ...
  public RiskAddressVerificationInformationBarCode getBarCode() {
    return barCode;
  }

  public void setBarCode(RiskAddressVerificationInformationBarCode barCode) {
    this.barCode = barCode;
  }

  public RiskAddressVerificationInformation applicableRegion(String applicableRegion) {
  ...
  **/
  ...
  public RiskAddressVerificationInformation errorCode(String errorCode) {
  ...
  **/
  ...
  public RiskAddressVerificationInformation statusCode(String statusCode) {
  ...
  **/
  ...
  public RiskAddressVerificationInformation careOf(String careOf) {
    this.careOf = careOf;
    return this;
  }
  ...
  **/
  ...
  public RiskAddressVerificationInformation matchScore(Integer matchScore) {
  ...
  **/
  ...
  public RiskAddressVerificationInformation standardAddress(RiskAddressVerificationInformationStandardAddress standardAddress) {
  ...
  **/
  @ApiModelProperty(value = "")
  public RiskAddressVerificationInformationStandardAddress getStandardAddress() {
    return standardAddress;
  }

  public void setStandardAddress(RiskAddressVerificationInformationStandardAddress standardAddress) {
    this.standardAddress = standardAddress;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RiskAddressVerificationInformation riskAddressVerificationInformation = (RiskAddressVerificationInformation) o;
    return Objects.equals(this.addressType, riskAddressVerificationInformation.addressType) &&
        Objects.equals(this.barCode, riskAddressVerificationInformation.barCode) &&
        Objects.equals(this.applicableRegion, riskAddressVerificationInformation.applicableRegion) &&
        Objects.equals(this.errorCode, riskAddressVerificationInformation.errorCode) &&
        Objects.equals(this.statusCode, riskAddressVerificationInformation.statusCode) &&
        Objects.equals(this.careOf, riskAddressVerificationInformation.careOf) &&
        Objects.equals(this.matchScore, riskAddressVerificationInformation.matchScore) &&
        Objects.equals(this.standardAddress, riskAddressVerificationInformation.standardAddress);
  }
  ...
  public String toString() {
    ...
    if (barCode != null) sb.append("    barCode: ").append(SENSITIVE_FIELD_PATTERN.matcher("barCode").matches() ? "[REDACTED]" : toIndentedString(barCode)).append("\n");
    if (applicableRegion != null) sb.append("    applicableRegion: ").append(SENSITIVE_FIELD_PATTERN.matcher("applicableRegion").matches() ? "[REDACTED]" : toIndentedString(applicableRegion)).append("\n");
    if (errorCode != null) sb.append("    errorCode: ").append(SENSITIVE_FIELD_PATTERN.matcher("errorCode").matches() ? "[REDACTED]" : toIndentedString(errorCode)).append("\n");
    ...
    if (careOf != null) sb.append("    careOf: ").append(SENSITIVE_FIELD_PATTERN.matcher("careOf").matches() ? "[REDACTED]" : toIndentedString(careOf)).append("\n");
    if (matchScore != null) sb.append("    matchScore: ").append(SENSITIVE_FIELD_PATTERN.matcher("matchScore").matches() ? "[REDACTED]" : toIndentedString(matchScore)).append("\n");
    if (standardAddress != null) sb.append("    standardAddress: ").append(SENSITIVE_FIELD_PATTERN.matcher("standardAddress").matches() ? "[REDACTED]" : toIndentedString(standardAddress)).append("\n");
    sb.append("}");
    return sb.toString();
  }
