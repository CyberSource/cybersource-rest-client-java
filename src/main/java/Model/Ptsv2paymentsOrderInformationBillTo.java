...
public class Ptsv2paymentsOrderInformationBillTo {
  ...
  **/
  ...
  public Ptsv2paymentsOrderInformationBillTo company(Ptsv2paymentsOrderInformationBillToCompany company) {
  ...
  **/
  ...
  public String toString() {
    ...
    if (alternatePhoneNumber != null) sb.append("    alternatePhoneNumber: ").append(SENSITIVE_FIELD_PATTERN.matcher("alternatePhoneNumber").matches() ? "[REDACTED]" : toIndentedString(alternatePhoneNumber)).append("\n");
    if (alternateEmail != null) sb.append("    alternateEmail: ").append(SENSITIVE_FIELD_PATTERN.matcher("alternateEmail").matches() ? "[REDACTED]" : toIndentedString(alternateEmail)).append("\n");
    sb.append("}");
    return sb.toString();
  }
