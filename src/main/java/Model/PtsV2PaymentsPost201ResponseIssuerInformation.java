...
public class PtsV2PaymentsPost201ResponseIssuerInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (discretionaryData != null) sb.append("    discretionaryData: ").append(SENSITIVE_FIELD_PATTERN.matcher("discretionaryData").matches() ? "[REDACTED]" : toIndentedString(discretionaryData)).append("\n");
    if (countrySpecificDiscretionaryData != null) sb.append("    countrySpecificDiscretionaryData: ").append(SENSITIVE_FIELD_PATTERN.matcher("countrySpecificDiscretionaryData").matches() ? "[REDACTED]" : toIndentedString(countrySpecificDiscretionaryData)).append("\n");
    ...
    if (pinRequestIndicator != null) sb.append("    pinRequestIndicator: ").append(SENSITIVE_FIELD_PATTERN.matcher("pinRequestIndicator").matches() ? "[REDACTED]" : toIndentedString(pinRequestIndicator)).append("\n");
    sb.append("}");
    return sb.toString();
  }
