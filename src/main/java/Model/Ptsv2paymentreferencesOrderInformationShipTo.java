...
public class Ptsv2paymentreferencesOrderInformationShipTo {
  ...
  **/
  ...
  public String toString() {
    ...
    if (immutable != null) sb.append("    immutable: ").append(SENSITIVE_FIELD_PATTERN.matcher("immutable").matches() ? "[REDACTED]" : toIndentedString(immutable)).append("\n");
    if (notApplicable != null) sb.append("    notApplicable: ").append(SENSITIVE_FIELD_PATTERN.matcher("notApplicable").matches() ? "[REDACTED]" : toIndentedString(notApplicable)).append("\n");
