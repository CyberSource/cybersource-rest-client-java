...
public class TssV2PostEmvTags200Response {
  ...
  **/
  ...
  public String toString() {
    ...
    if (parsedEMVTagsList != null) sb.append("    parsedEMVTagsList: ").append(SENSITIVE_FIELD_PATTERN.matcher("parsedEMVTagsList").matches() ? "[REDACTED]" : toIndentedString(parsedEMVTagsList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
