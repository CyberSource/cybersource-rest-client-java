...
public class InlineResponse2002Embedded {
  ...
  private List<InlineResponse2002EmbeddedBatches> batches = null;

  public InlineResponse2002Embedded batches(List<InlineResponse2002EmbeddedBatches> batches) {
  ...
  public InlineResponse2002Embedded addBatchesItem(InlineResponse2002EmbeddedBatches batchesItem) {
    if (this.batches == null) {
      this.batches = new ArrayList<InlineResponse2002EmbeddedBatches>();
    }
  ...
  **/
  ...
  public List<InlineResponse2002EmbeddedBatches> getBatches() {
    return batches;
  }

  public void setBatches(List<InlineResponse2002EmbeddedBatches> batches) {
    this.batches = batches;
  }
