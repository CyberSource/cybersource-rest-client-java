...
public class CardProcessingConfigFeaturesCardNotPresentPayoutsCurrencies {
  ...
  **/
  ...
  public String toString() {
    ...
    if (enabledCardPresent != null) sb.append("    enabledCardPresent: ").append(SENSITIVE_FIELD_PATTERN.matcher("enabledCardPresent").matches() ? "[REDACTED]" : toIndentedString(enabledCardPresent)).append("\n");
    if (enabledCardNotPresent != null) sb.append("    enabledCardNotPresent: ").append(SENSITIVE_FIELD_PATTERN.matcher("enabledCardNotPresent").matches() ? "[REDACTED]" : toIndentedString(enabledCardNotPresent)).append("\n");
    ...
    if (terminalIds != null) sb.append("    terminalIds: ").append(SENSITIVE_FIELD_PATTERN.matcher("terminalIds").matches() ? "[REDACTED]" : toIndentedString(terminalIds)).append("\n");
    if (serviceEnablementNumber != null) sb.append("    serviceEnablementNumber: ").append(SENSITIVE_FIELD_PATTERN.matcher("serviceEnablementNumber").matches() ? "[REDACTED]" : toIndentedString(serviceEnablementNumber)).append("\n");
    sb.append("}");
    return sb.toString();
  }
