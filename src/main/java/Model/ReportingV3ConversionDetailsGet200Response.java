...
public class ReportingV3ConversionDetailsGet200Response {
  ...
  **/
  ...
  public String toString() {
    ...
    if (conversionDetails != null) sb.append("    conversionDetails: ").append(SENSITIVE_FIELD_PATTERN.matcher("conversionDetails").matches() ? "[REDACTED]" : toIndentedString(conversionDetails)).append("\n");
    sb.append("}");
    return sb.toString();
  }
