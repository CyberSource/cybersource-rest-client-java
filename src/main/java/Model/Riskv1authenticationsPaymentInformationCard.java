...
public class Riskv1authenticationsPaymentInformationCard {
  ...
  **/
   ...
   * @return number
  **/
  @ApiModelProperty(required = true, value = "The customer’s payment card number, also knows as the Primary Account Nunmber (PAN). You can also use this field for encoded account numbers.  For processor-specific information, see the `customer_cc_number` field description in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.type, riskv1authenticationsPaymentInformationCard.type) &&
