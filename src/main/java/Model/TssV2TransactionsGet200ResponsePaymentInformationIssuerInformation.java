...
public class TssV2TransactionsGet200ResponsePaymentInformationIssuerInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (transactionInformation != null) sb.append("    transactionInformation: ").append(SENSITIVE_FIELD_PATTERN.matcher("transactionInformation").matches() ? "[REDACTED]" : toIndentedString(transactionInformation)).append("\n");
    sb.append("}");
    return sb.toString();
  }
