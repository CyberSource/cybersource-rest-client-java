...
public class Ptsv2paymentsidOrderInformationAmountDetails {
  ...
  **/
  ...
  public String toString() {
    ...
    if (additionalAmount != null) sb.append("    additionalAmount: ").append(SENSITIVE_FIELD_PATTERN.matcher("additionalAmount").matches() ? "[REDACTED]" : toIndentedString(additionalAmount)).append("\n");
