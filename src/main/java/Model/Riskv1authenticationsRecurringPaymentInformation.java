...
public class Riskv1authenticationsRecurringPaymentInformation {
  ...
  **/
   ...
   * @return frequency
  **/
  @ApiModelProperty(value = "Integer value indicating the minimum number of days between recurring authorizations. A frequency of monthly is indicated by the value 28. Multiple of 28 days will be used to indicate months. Example: 6 months = 168 **Note** This field is required for recurring transactions. ")
  ...
  **/
  @ApiModelProperty(value = "Date of original purchase. Required for recurring transactions. Format: `YYYYMMDD:HH:MM:SS` **Note**: If this field is empty, the current date is used. ")
