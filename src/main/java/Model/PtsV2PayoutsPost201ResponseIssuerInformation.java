...
public class PtsV2PayoutsPost201ResponseIssuerInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (serviceProcessingType != null) sb.append("    serviceProcessingType: ").append(SENSITIVE_FIELD_PATTERN.matcher("serviceProcessingType").matches() ? "[REDACTED]" : toIndentedString(serviceProcessingType)).append("\n");
    sb.append("}");
    return sb.toString();
  }
