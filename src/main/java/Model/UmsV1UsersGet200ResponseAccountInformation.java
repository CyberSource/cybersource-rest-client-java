...
public class UmsV1UsersGet200ResponseAccountInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (roleId != null) sb.append("    roleId: ").append(SENSITIVE_FIELD_PATTERN.matcher("roleId").matches() ? "[REDACTED]" : toIndentedString(roleId)).append("\n");
    if (permissions != null) sb.append("    permissions: ").append(SENSITIVE_FIELD_PATTERN.matcher("permissions").matches() ? "[REDACTED]" : toIndentedString(permissions)).append("\n");
    ...
    if (lastAccessTime != null) sb.append("    lastAccessTime: ").append(SENSITIVE_FIELD_PATTERN.matcher("lastAccessTime").matches() ? "[REDACTED]" : toIndentedString(lastAccessTime)).append("\n");
