...
public class Upv1capturecontextsCaptureMandate {
  ...
  **/
  ...
  public String toString() {
    ...
    if (requestSaveCard != null) sb.append("    requestSaveCard: ").append(SENSITIVE_FIELD_PATTERN.matcher("requestSaveCard").matches() ? "[REDACTED]" : toIndentedString(requestSaveCard)).append("\n");
