...
public class TssV2TransactionsPost201ResponseEmbeddedProcessorInformation {
  ...
  **/
  ...
  public TssV2TransactionsPost201ResponseEmbeddedProcessorInformation providerTransactionId(String providerTransactionId) {
  ...
  **/
  ...
  public String toString() {
    ...
    if (providerTransactionId != null) sb.append("    providerTransactionId: ").append(SENSITIVE_FIELD_PATTERN.matcher("providerTransactionId").matches() ? "[REDACTED]" : toIndentedString(providerTransactionId)).append("\n");
