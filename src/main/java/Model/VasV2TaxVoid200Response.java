...
public class VasV2TaxVoid200Response {
  ...
  **/
  ...
  public String toString() {
    ...
    if (voidAmountDetails != null) sb.append("    voidAmountDetails: ").append(SENSITIVE_FIELD_PATTERN.matcher("voidAmountDetails").matches() ? "[REDACTED]" : toIndentedString(voidAmountDetails)).append("\n");
    sb.append("}");
    return sb.toString();
  }
