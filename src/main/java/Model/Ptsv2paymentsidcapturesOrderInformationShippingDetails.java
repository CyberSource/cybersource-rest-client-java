...
public class Ptsv2paymentsidcapturesOrderInformationShippingDetails {
  ...
  **/
  ...
  public String toString() {
    ...
    if (trackingUrl != null) sb.append("    trackingUrl: ").append(SENSITIVE_FIELD_PATTERN.matcher("trackingUrl").matches() ? "[REDACTED]" : toIndentedString(trackingUrl)).append("\n");
    if (shippingCarrier != null) sb.append("    shippingCarrier: ").append(SENSITIVE_FIELD_PATTERN.matcher("shippingCarrier").matches() ? "[REDACTED]" : toIndentedString(shippingCarrier)).append("\n");
    if (estimatedDeliveryDate != null) sb.append("    estimatedDeliveryDate: ").append(SENSITIVE_FIELD_PATTERN.matcher("estimatedDeliveryDate").matches() ? "[REDACTED]" : toIndentedString(estimatedDeliveryDate)).append("\n");
