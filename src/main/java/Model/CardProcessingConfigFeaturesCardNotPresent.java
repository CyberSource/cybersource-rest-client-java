...
public class CardProcessingConfigFeaturesCardNotPresent {
  ...
  **/
  ...
  public String toString() {
    ...
    if (ignoreAddressVerificationSystem != null) sb.append("    ignoreAddressVerificationSystem: ").append(SENSITIVE_FIELD_PATTERN.matcher("ignoreAddressVerificationSystem").matches() ? "[REDACTED]" : toIndentedString(ignoreAddressVerificationSystem)).append("\n");
    if (visaStraightThroughProcessingOnly != null) sb.append("    visaStraightThroughProcessingOnly: ").append(SENSITIVE_FIELD_PATTERN.matcher("visaStraightThroughProcessingOnly").matches() ? "[REDACTED]" : toIndentedString(visaStraightThroughProcessingOnly)).append("\n");
    ...
    if (installment != null) sb.append("    installment: ").append(SENSITIVE_FIELD_PATTERN.matcher("installment").matches() ? "[REDACTED]" : toIndentedString(installment)).append("\n");
    sb.append("}");
    return sb.toString();
  }
