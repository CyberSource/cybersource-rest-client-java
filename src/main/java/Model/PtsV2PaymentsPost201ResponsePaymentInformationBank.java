...
public class PtsV2PaymentsPost201ResponsePaymentInformationBank {
  ...
  **/
  ...
  public String toString() {
    ...
    if (correctedRoutingNumber != null) sb.append("    correctedRoutingNumber: ").append(SENSITIVE_FIELD_PATTERN.matcher("correctedRoutingNumber").matches() ? "[REDACTED]" : toIndentedString(correctedRoutingNumber)).append("\n");
    sb.append("}");
    return sb.toString();
  }
