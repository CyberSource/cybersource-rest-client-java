...
public class PayerAuthConfigCardTypesVerifiedByVisaCurrencies {
  ...
  **/
  ...
  public String toString() {
    ...
    if (currencyCodes != null) sb.append("    currencyCodes: ").append(SENSITIVE_FIELD_PATTERN.matcher("currencyCodes").matches() ? "[REDACTED]" : toIndentedString(currencyCodes)).append("\n");
