...
public class PtsV2PaymentsPost201ResponseOrderInformationBillTo {
  ...
  **/
  ...
  public String toString() {
    ...
    if (alternatePhoneNumberVerificationStatus != null) sb.append("    alternatePhoneNumberVerificationStatus: ").append(SENSITIVE_FIELD_PATTERN.matcher("alternatePhoneNumberVerificationStatus").matches() ? "[REDACTED]" : toIndentedString(alternatePhoneNumberVerificationStatus)).append("\n");
    if (alternateEmailVerificationStatus != null) sb.append("    alternateEmailVerificationStatus: ").append(SENSITIVE_FIELD_PATTERN.matcher("alternateEmailVerificationStatus").matches() ? "[REDACTED]" : toIndentedString(alternateEmailVerificationStatus)).append("\n");
