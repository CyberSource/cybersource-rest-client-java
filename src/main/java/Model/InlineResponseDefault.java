...
public class InlineResponseDefault {
  ...
  **/
  ...
  public String toString() {
    ...
    if (responseStatus != null) sb.append("    responseStatus: ").append(SENSITIVE_FIELD_PATTERN.matcher("responseStatus").matches() ? "[REDACTED]" : toIndentedString(responseStatus)).append("\n");
