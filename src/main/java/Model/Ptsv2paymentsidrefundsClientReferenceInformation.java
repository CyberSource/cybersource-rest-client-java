...
public class Ptsv2paymentsidrefundsClientReferenceInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (returnReconciliationId != null) sb.append("    returnReconciliationId: ").append(SENSITIVE_FIELD_PATTERN.matcher("returnReconciliationId").matches() ? "[REDACTED]" : toIndentedString(returnReconciliationId)).append("\n");
