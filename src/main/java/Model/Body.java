...
public class Body {
  ...
  **/
  ...
  public String toString() {
    ...
    if (included != null) sb.append("    included: ").append(SENSITIVE_FIELD_PATTERN.matcher("included").matches() ? "[REDACTED]" : toIndentedString(included)).append("\n");
    ...
    if (notificationEmail != null) sb.append("    notificationEmail: ").append(SENSITIVE_FIELD_PATTERN.matcher("notificationEmail").matches() ? "[REDACTED]" : toIndentedString(notificationEmail)).append("\n");
    sb.append("}");
    return sb.toString();
  }
