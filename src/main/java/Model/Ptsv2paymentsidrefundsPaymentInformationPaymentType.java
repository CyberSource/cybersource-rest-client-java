...
public class Ptsv2paymentsidrefundsPaymentInformationPaymentType {
  ...
  **/
  ...
  public Ptsv2paymentsidrefundsPaymentInformationPaymentType method(Ptsv2paymentsidcapturesPaymentInformationPaymentTypeMethod method) {
    this.method = method;
    return this;
  }
  ...
  **/
  ...
  public String toString() {
    ...
    if (subTypeName != null) sb.append("    subTypeName: ").append(SENSITIVE_FIELD_PATTERN.matcher("subTypeName").matches() ? "[REDACTED]" : toIndentedString(subTypeName)).append("\n");
