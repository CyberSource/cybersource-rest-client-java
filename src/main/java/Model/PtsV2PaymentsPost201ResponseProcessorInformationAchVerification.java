...
public class PtsV2PaymentsPost201ResponseProcessorInformationAchVerification {
  ...
  **/
  ...
  public String toString() {
    ...
    if (resultCodeRaw != null) sb.append("    resultCodeRaw: ").append(SENSITIVE_FIELD_PATTERN.matcher("resultCodeRaw").matches() ? "[REDACTED]" : toIndentedString(resultCodeRaw)).append("\n");
    sb.append("}");
    return sb.toString();
  }
