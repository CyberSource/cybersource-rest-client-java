...
public class Ptsv2paymentsOrderInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (extensionDays != null) sb.append("    extensionDays: ").append(SENSITIVE_FIELD_PATTERN.matcher("extensionDays").matches() ? "[REDACTED]" : toIndentedString(extensionDays)).append("\n");
    ...
    if (digitalCurrency != null) sb.append("    digitalCurrency: ").append(SENSITIVE_FIELD_PATTERN.matcher("digitalCurrency").matches() ? "[REDACTED]" : toIndentedString(digitalCurrency)).append("\n");
