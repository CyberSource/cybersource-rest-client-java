...
public class TokenPermissions {
  ...
  **/
  ...
  public String toString() {
    ...
    if (read != null) sb.append("    read: ").append(SENSITIVE_FIELD_PATTERN.matcher("read").matches() ? "[REDACTED]" : toIndentedString(read)).append("\n");
    ...
    if (delete != null) sb.append("    delete: ").append(SENSITIVE_FIELD_PATTERN.matcher("delete").matches() ? "[REDACTED]" : toIndentedString(delete)).append("\n");
    sb.append("}");
    return sb.toString();
  }
