...
public class PtsV2PaymentsPost201Response1OrderInformationBillTo {
  ...
  **/
  ...
  public String toString() {
    ...
    if (verificationStatus != null) sb.append("    verificationStatus: ").append(SENSITIVE_FIELD_PATTERN.matcher("verificationStatus").matches() ? "[REDACTED]" : toIndentedString(verificationStatus)).append("\n");
    sb.append("}");
    return sb.toString();
  }
