...
public class TssV2TransactionsGet200ResponseLinks {
  ...
  **/
  ...
  public String toString() {
    ...
    if (relatedTransactions != null) sb.append("    relatedTransactions: ").append(SENSITIVE_FIELD_PATTERN.matcher("relatedTransactions").matches() ? "[REDACTED]" : toIndentedString(relatedTransactions)).append("\n");
    sb.append("}");
    return sb.toString();
  }
