...
public class RiskV1AuthenticationsPost400Response {
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(value = "The status for payerAuthentication 400 setup calls. Possible values are: - INVALID_REQUEST ")
  ...
  **/
   ...
   * @return message
  **/
  @ApiModelProperty(value = "The message describing the reason of the status. Value is: - Encountered a Payer Authentication problem. Payer could not be setup. ")
