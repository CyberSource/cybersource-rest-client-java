...
public class ReportingV3PurchaseRefundDetailsGet200ResponseOthers {
  ...
  **/
  ...
  public String toString() {
    ...
    if (merchantData1 != null) sb.append("    merchantData1: ").append(SENSITIVE_FIELD_PATTERN.matcher("merchantData1").matches() ? "[REDACTED]" : toIndentedString(merchantData1)).append("\n");
    if (merchantData2 != null) sb.append("    merchantData2: ").append(SENSITIVE_FIELD_PATTERN.matcher("merchantData2").matches() ? "[REDACTED]" : toIndentedString(merchantData2)).append("\n");
    if (merchantData3 != null) sb.append("    merchantData3: ").append(SENSITIVE_FIELD_PATTERN.matcher("merchantData3").matches() ? "[REDACTED]" : toIndentedString(merchantData3)).append("\n");
    if (merchantData4 != null) sb.append("    merchantData4: ").append(SENSITIVE_FIELD_PATTERN.matcher("merchantData4").matches() ? "[REDACTED]" : toIndentedString(merchantData4)).append("\n");
