...
public class ReportingV3ReportsGet200Response {
  ...
  **/
  ...
  public String toString() {
    ...
    if (reportSearchResults != null) sb.append("    reportSearchResults: ").append(SENSITIVE_FIELD_PATTERN.matcher("reportSearchResults").matches() ? "[REDACTED]" : toIndentedString(reportSearchResults)).append("\n");
    sb.append("}");
    return sb.toString();
  }
