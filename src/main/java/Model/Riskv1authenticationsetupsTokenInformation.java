...
public class Riskv1authenticationsetupsTokenInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (transientToken != null) sb.append("    transientToken: ").append(SENSITIVE_FIELD_PATTERN.matcher("transientToken").matches() ? "[REDACTED]" : toIndentedString(transientToken)).append("\n");
