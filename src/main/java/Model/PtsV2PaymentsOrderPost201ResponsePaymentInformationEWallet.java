...
public class PtsV2PaymentsOrderPost201ResponsePaymentInformationEWallet {
  ...
  **/
  ...
  public String toString() {
    ...
    if (fundingSourceSale != null) sb.append("    fundingSourceSale: ").append(SENSITIVE_FIELD_PATTERN.matcher("fundingSourceSale").matches() ? "[REDACTED]" : toIndentedString(fundingSourceSale)).append("\n");
