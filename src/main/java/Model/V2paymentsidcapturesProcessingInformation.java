...
import Model.V2paymentsidcapturesProcessingInformationAuthorizationOptions;
import Model.V2paymentsidcapturesProcessingInformationCaptureOptions;
...
public class V2paymentsidcapturesProcessingInformation {
  ...
  private V2paymentsidcapturesProcessingInformationAuthorizationOptions authorizationOptions = null;

  @SerializedName("captureOptions")
  private V2paymentsidcapturesProcessingInformationCaptureOptions captureOptions = null;

  public V2paymentsidcapturesProcessingInformation paymentSolution(String paymentSolution) {
  ...
  **/
  ...
  public V2paymentsidcapturesProcessingInformation reconciliationId(String reconciliationId) {
  ...
  **/
  ...
  public V2paymentsidcapturesProcessingInformation linkId(String linkId) {
    this.linkId = linkId;
    return this;
  }
  ...
  **/
  ...
  public V2paymentsidcapturesProcessingInformation reportGroup(String reportGroup) {
  ...
  **/
  ...
  public V2paymentsidcapturesProcessingInformation visaCheckoutId(String visaCheckoutId) {
  ...
  **/
  ...
  public V2paymentsidcapturesProcessingInformation purchaseLevel(String purchaseLevel) {
  ...
  **/
  ...
  public V2paymentsidcapturesProcessingInformation issuer(V2paymentsProcessingInformationIssuer issuer) {
    this.issuer = issuer;
    return this;
  }
  ...
  **/
  ...
  public V2paymentsidcapturesProcessingInformation authorizationOptions(V2paymentsidcapturesProcessingInformationAuthorizationOptions authorizationOptions) {
  ...
  **/
  @ApiModelProperty(value = "")
  public V2paymentsidcapturesProcessingInformationAuthorizationOptions getAuthorizationOptions() {
    return authorizationOptions;
  }

  public void setAuthorizationOptions(V2paymentsidcapturesProcessingInformationAuthorizationOptions authorizationOptions) {
    this.authorizationOptions = authorizationOptions;
  }

  public V2paymentsidcapturesProcessingInformation captureOptions(V2paymentsidcapturesProcessingInformationCaptureOptions captureOptions) {
  ...
  **/
  @ApiModelProperty(value = "")
  public V2paymentsidcapturesProcessingInformationCaptureOptions getCaptureOptions() {
    return captureOptions;
  }

  public void setCaptureOptions(V2paymentsidcapturesProcessingInformationCaptureOptions captureOptions) {
    this.captureOptions = captureOptions;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V2paymentsidcapturesProcessingInformation v2paymentsidcapturesProcessingInformation = (V2paymentsidcapturesProcessingInformation) o;
    return Objects.equals(this.paymentSolution, v2paymentsidcapturesProcessingInformation.paymentSolution) &&
        Objects.equals(this.reconciliationId, v2paymentsidcapturesProcessingInformation.reconciliationId) &&
        Objects.equals(this.linkId, v2paymentsidcapturesProcessingInformation.linkId) &&
        Objects.equals(this.reportGroup, v2paymentsidcapturesProcessingInformation.reportGroup) &&
        Objects.equals(this.visaCheckoutId, v2paymentsidcapturesProcessingInformation.visaCheckoutId) &&
        Objects.equals(this.purchaseLevel, v2paymentsidcapturesProcessingInformation.purchaseLevel) &&
        Objects.equals(this.issuer, v2paymentsidcapturesProcessingInformation.issuer) &&
        Objects.equals(this.authorizationOptions, v2paymentsidcapturesProcessingInformation.authorizationOptions) &&
        Objects.equals(this.captureOptions, v2paymentsidcapturesProcessingInformation.captureOptions);
  }
