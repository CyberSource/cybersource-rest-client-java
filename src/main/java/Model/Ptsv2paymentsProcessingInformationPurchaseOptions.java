...
public class Ptsv2paymentsProcessingInformationPurchaseOptions {
  ...
  **/
  ...
  public String toString() {
    ...
    if (eligibilityIndicator != null) sb.append("    eligibilityIndicator: ").append(SENSITIVE_FIELD_PATTERN.matcher("eligibilityIndicator").matches() ? "[REDACTED]" : toIndentedString(eligibilityIndicator)).append("\n");
