...
public class PtsV2PaymentsPost201ResponsePointOfSaleInformationEmv {
  ...
  **/
  ...
  public String toString() {
    ...
    if (chipValidationType != null) sb.append("    chipValidationType: ").append(SENSITIVE_FIELD_PATTERN.matcher("chipValidationType").matches() ? "[REDACTED]" : toIndentedString(chipValidationType)).append("\n");
    if (chipValidationResult != null) sb.append("    chipValidationResult: ").append(SENSITIVE_FIELD_PATTERN.matcher("chipValidationResult").matches() ? "[REDACTED]" : toIndentedString(chipValidationResult)).append("\n");
    sb.append("}");
    return sb.toString();
  }
