...
public class ECheckConfigCommonInternalOnlyProcessors {
  ...
  **/
  ...
  public String toString() {
    ...
    if (enableCCS != null) sb.append("    enableCCS: ").append(SENSITIVE_FIELD_PATTERN.matcher("enableCCS").matches() ? "[REDACTED]" : toIndentedString(enableCCS)).append("\n");
    ...
    if (enable15anTransactionReferenceNumber != null) sb.append("    enable15anTransactionReferenceNumber: ").append(SENSITIVE_FIELD_PATTERN.matcher("enable15anTransactionReferenceNumber").matches() ? "[REDACTED]" : toIndentedString(enable15anTransactionReferenceNumber)).append("\n");
    if (portalSupportedPaytypes != null) sb.append("    portalSupportedPaytypes: ").append(SENSITIVE_FIELD_PATTERN.matcher("portalSupportedPaytypes").matches() ? "[REDACTED]" : toIndentedString(portalSupportedPaytypes)).append("\n");
    ...
    if (verificationLevel != null) sb.append("    verificationLevel: ").append(SENSITIVE_FIELD_PATTERN.matcher("verificationLevel").matches() ? "[REDACTED]" : toIndentedString(verificationLevel)).append("\n");
