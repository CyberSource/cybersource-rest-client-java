...
public class Boardingv1registrationsDocumentInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (signedDocuments != null) sb.append("    signedDocuments: ").append(SENSITIVE_FIELD_PATTERN.matcher("signedDocuments").matches() ? "[REDACTED]" : toIndentedString(signedDocuments)).append("\n");
    sb.append("}");
    return sb.toString();
  }
