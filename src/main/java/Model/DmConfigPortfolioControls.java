...
public class DmConfigPortfolioControls {
  ...
  **/
  ...
  public String toString() {
    ...
    if (hideRiskMenus != null) sb.append("    hideRiskMenus: ").append(SENSITIVE_FIELD_PATTERN.matcher("hideRiskMenus").matches() ? "[REDACTED]" : toIndentedString(hideRiskMenus)).append("\n");
    if (hideRiskTransactionData != null) sb.append("    hideRiskTransactionData: ").append(SENSITIVE_FIELD_PATTERN.matcher("hideRiskTransactionData").matches() ? "[REDACTED]" : toIndentedString(hideRiskTransactionData)).append("\n");
    sb.append("}");
    return sb.toString();
  }
