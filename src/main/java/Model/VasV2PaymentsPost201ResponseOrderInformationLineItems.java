...
public class VasV2PaymentsPost201ResponseOrderInformationLineItems {
  ...
  **/
  ...
  public String toString() {
    ...
    if (jurisdiction != null) sb.append("    jurisdiction: ").append(SENSITIVE_FIELD_PATTERN.matcher("jurisdiction").matches() ? "[REDACTED]" : toIndentedString(jurisdiction)).append("\n");
    if (exemptAmount != null) sb.append("    exemptAmount: ").append(SENSITIVE_FIELD_PATTERN.matcher("exemptAmount").matches() ? "[REDACTED]" : toIndentedString(exemptAmount)).append("\n");
    if (taxableAmount != null) sb.append("    taxableAmount: ").append(SENSITIVE_FIELD_PATTERN.matcher("taxableAmount").matches() ? "[REDACTED]" : toIndentedString(taxableAmount)).append("\n");
