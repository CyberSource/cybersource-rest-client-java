...
public class UnderwritingConfigurationMerchantApplication {
  ...
  **/
  ...
  public String toString() {
    ...
    if (applicationId != null) sb.append("    applicationId: ").append(SENSITIVE_FIELD_PATTERN.matcher("applicationId").matches() ? "[REDACTED]" : toIndentedString(applicationId)).append("\n");
    if (applicationStatus != null) sb.append("    applicationStatus: ").append(SENSITIVE_FIELD_PATTERN.matcher("applicationStatus").matches() ? "[REDACTED]" : toIndentedString(applicationStatus)).append("\n");
    ...
    if (campaignId != null) sb.append("    campaignId: ").append(SENSITIVE_FIELD_PATTERN.matcher("campaignId").matches() ? "[REDACTED]" : toIndentedString(campaignId)).append("\n");
    if (ocId != null) sb.append("    ocId: ").append(SENSITIVE_FIELD_PATTERN.matcher("ocId").matches() ? "[REDACTED]" : toIndentedString(ocId)).append("\n");
    if (resellerId != null) sb.append("    resellerId: ").append(SENSITIVE_FIELD_PATTERN.matcher("resellerId").matches() ? "[REDACTED]" : toIndentedString(resellerId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
