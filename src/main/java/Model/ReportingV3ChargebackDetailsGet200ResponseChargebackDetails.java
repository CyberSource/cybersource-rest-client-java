...
public class ReportingV3ChargebackDetailsGet200ResponseChargebackDetails {
  ...
  **/
  ...
  public String toString() {
    ...
    if (preDisputeFlag != null) sb.append("    preDisputeFlag: ").append(SENSITIVE_FIELD_PATTERN.matcher("preDisputeFlag").matches() ? "[REDACTED]" : toIndentedString(preDisputeFlag)).append("\n");
    sb.append("}");
    return sb.toString();
  }
