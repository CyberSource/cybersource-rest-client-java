...
import Model.Ucv1sessionsDataSenderInformationAccount;
...
public class Ucv1sessionsDataSenderInformation {
  ...
  private Ucv1sessionsDataSenderInformationAccount account = null;

  public Ucv1sessionsDataSenderInformation firstName(String firstName) {
  ...
  **/
  ...
  public Ucv1sessionsDataSenderInformation middleName(String middleName) {
  ...
  **/
  ...
  public Ucv1sessionsDataSenderInformation lastName(String lastName) {
  ...
  **/
  ...
  public Ucv1sessionsDataSenderInformation address1(String address1) {
  ...
  **/
  ...
  public Ucv1sessionsDataSenderInformation locality(String locality) {
  ...
  **/
  ...
  public Ucv1sessionsDataSenderInformation administrativeArea(String administrativeArea) {
  ...
  **/
  ...
  public Ucv1sessionsDataSenderInformation postalCode(String postalCode) {
  ...
  **/
  ...
  public Ucv1sessionsDataSenderInformation countryCode(String countryCode) {
  ...
  **/
  ...
  public Ucv1sessionsDataSenderInformation phoneNumber(String phoneNumber) {
   ...
   * @return phoneNumber
  **/
  @ApiModelProperty(value = "Sender phone number")
  ...
  public Ucv1sessionsDataSenderInformation dateOfBirth(String dateOfBirth) {
   ...
   * @return dateOfBirth
  **/
  @ApiModelProperty(value = "Sender's date of birth. **Format**: `YYYYMMDD`.  This field is a `pass-through`, which means that CyberSource ensures that the value is eight numeric characters but otherwise does not verify the value or modify it in any way before sending it to the processor. If the field is not required for the transaction, CyberSource does not forward it to the processor. ")
  ...
  public Ucv1sessionsDataSenderInformation accountType(String accountType) {
  ...
  **/
  ...
  public Ucv1sessionsDataSenderInformation account(Ucv1sessionsDataSenderInformationAccount account) {
  ...
  **/
  ...
  public Ucv1sessionsDataSenderInformationAccount getAccount() {
    return account;
  }

  public void setAccount(Ucv1sessionsDataSenderInformationAccount account) {
    this.account = account;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Ucv1sessionsDataSenderInformation ucv1sessionsDataSenderInformation = (Ucv1sessionsDataSenderInformation) o;
    return Objects.equals(this.firstName, ucv1sessionsDataSenderInformation.firstName) &&
        Objects.equals(this.middleName, ucv1sessionsDataSenderInformation.middleName) &&
        Objects.equals(this.lastName, ucv1sessionsDataSenderInformation.lastName) &&
        Objects.equals(this.address1, ucv1sessionsDataSenderInformation.address1) &&
        Objects.equals(this.locality, ucv1sessionsDataSenderInformation.locality) &&
        Objects.equals(this.administrativeArea, ucv1sessionsDataSenderInformation.administrativeArea) &&
        Objects.equals(this.postalCode, ucv1sessionsDataSenderInformation.postalCode) &&
        Objects.equals(this.countryCode, ucv1sessionsDataSenderInformation.countryCode) &&
        Objects.equals(this.phoneNumber, ucv1sessionsDataSenderInformation.phoneNumber) &&
        Objects.equals(this.dateOfBirth, ucv1sessionsDataSenderInformation.dateOfBirth) &&
        Objects.equals(this.accountType, ucv1sessionsDataSenderInformation.accountType) &&
        Objects.equals(this.account, ucv1sessionsDataSenderInformation.account);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firstName, middleName, lastName, address1, locality, administrativeArea, postalCode, countryCode, phoneNumber, dateOfBirth, accountType, account);
  }
