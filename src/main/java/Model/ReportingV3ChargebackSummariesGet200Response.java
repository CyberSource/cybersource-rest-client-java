...
public class ReportingV3ChargebackSummariesGet200Response {
  ...
  **/
  ...
  public String toString() {
    ...
    if (chargebackSummaries != null) sb.append("    chargebackSummaries: ").append(SENSITIVE_FIELD_PATTERN.matcher("chargebackSummaries").matches() ? "[REDACTED]" : toIndentedString(chargebackSummaries)).append("\n");
    sb.append("}");
    return sb.toString();
  }
