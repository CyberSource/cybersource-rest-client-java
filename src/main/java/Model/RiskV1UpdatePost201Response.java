...
public class RiskV1UpdatePost201Response {
  ...
  **/
  ...
  public String toString() {
    ...
    if (clientReferenceInformaton != null) sb.append("    clientReferenceInformaton: ").append(SENSITIVE_FIELD_PATTERN.matcher("clientReferenceInformaton").matches() ? "[REDACTED]" : toIndentedString(clientReferenceInformaton)).append("\n");
