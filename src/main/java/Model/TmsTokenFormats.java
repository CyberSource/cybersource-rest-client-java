...
public class TmsTokenFormats {
  ...
  **/
  ...
  public String toString() {
    ...
    if (instrumentIdentifierCard != null) sb.append("    instrumentIdentifierCard: ").append(SENSITIVE_FIELD_PATTERN.matcher("instrumentIdentifierCard").matches() ? "[REDACTED]" : toIndentedString(instrumentIdentifierCard)).append("\n");
    if (instrumentIdentifierBankAccount != null) sb.append("    instrumentIdentifierBankAccount: ").append(SENSITIVE_FIELD_PATTERN.matcher("instrumentIdentifierBankAccount").matches() ? "[REDACTED]" : toIndentedString(instrumentIdentifierBankAccount)).append("\n");
    sb.append("}");
    return sb.toString();
  }
