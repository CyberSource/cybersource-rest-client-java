...
public class PtsV2PaymentsPost201ResponsePaymentInformationBankAccount {
  ...
  **/
  ...
  public String toString() {
    ...
    if (correctedAccountNumber != null) sb.append("    correctedAccountNumber: ").append(SENSITIVE_FIELD_PATTERN.matcher("correctedAccountNumber").matches() ? "[REDACTED]" : toIndentedString(correctedAccountNumber)).append("\n");
    sb.append("}");
    return sb.toString();
  }
