...
public class Ptsv2paymentsProcessingInformationCaptureOptions {
  ...
  **/
  ...
  public String toString() {
    ...
    if (captureSequenceNumber != null) sb.append("    captureSequenceNumber: ").append(SENSITIVE_FIELD_PATTERN.matcher("captureSequenceNumber").matches() ? "[REDACTED]" : toIndentedString(captureSequenceNumber)).append("\n");
    if (totalCaptureCount != null) sb.append("    totalCaptureCount: ").append(SENSITIVE_FIELD_PATTERN.matcher("totalCaptureCount").matches() ? "[REDACTED]" : toIndentedString(totalCaptureCount)).append("\n");
    if (dateToCapture != null) sb.append("    dateToCapture: ").append(SENSITIVE_FIELD_PATTERN.matcher("dateToCapture").matches() ? "[REDACTED]" : toIndentedString(dateToCapture)).append("\n");
    if (isFinal != null) sb.append("    isFinal: ").append(SENSITIVE_FIELD_PATTERN.matcher("isFinal").matches() ? "[REDACTED]" : toIndentedString(isFinal)).append("\n");
