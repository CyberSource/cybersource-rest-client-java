...
public class CheckPayerAuthEnrollmentRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clientReferenceInformation, orderInformation, paymentInformation, buyerInformation, deviceInformation, merchantInformation, recurringPaymentInformation, consumerAuthenticationInformation, riskInformation, travelInformation, merchantDefinedInformation);
  }
