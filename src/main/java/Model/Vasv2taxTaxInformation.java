...
public class Vasv2taxTaxInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (reportingDate != null) sb.append("    reportingDate: ").append(SENSITIVE_FIELD_PATTERN.matcher("reportingDate").matches() ? "[REDACTED]" : toIndentedString(reportingDate)).append("\n");
    if (dateOverrideReason != null) sb.append("    dateOverrideReason: ").append(SENSITIVE_FIELD_PATTERN.matcher("dateOverrideReason").matches() ? "[REDACTED]" : toIndentedString(dateOverrideReason)).append("\n");
    if (nexus != null) sb.append("    nexus: ").append(SENSITIVE_FIELD_PATTERN.matcher("nexus").matches() ? "[REDACTED]" : toIndentedString(nexus)).append("\n");
    if (noNexus != null) sb.append("    noNexus: ").append(SENSITIVE_FIELD_PATTERN.matcher("noNexus").matches() ? "[REDACTED]" : toIndentedString(noNexus)).append("\n");
    if (showTaxPerLineItem != null) sb.append("    showTaxPerLineItem: ").append(SENSITIVE_FIELD_PATTERN.matcher("showTaxPerLineItem").matches() ? "[REDACTED]" : toIndentedString(showTaxPerLineItem)).append("\n");
    if (commitIndicator != null) sb.append("    commitIndicator: ").append(SENSITIVE_FIELD_PATTERN.matcher("commitIndicator").matches() ? "[REDACTED]" : toIndentedString(commitIndicator)).append("\n");
    if (refundIndicator != null) sb.append("    refundIndicator: ").append(SENSITIVE_FIELD_PATTERN.matcher("refundIndicator").matches() ? "[REDACTED]" : toIndentedString(refundIndicator)).append("\n");
    sb.append("}");
    return sb.toString();
  }
