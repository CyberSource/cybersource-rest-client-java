...
public class PtsV2PaymentsPost201ResponseRiskInformationIpAddress {
  ...
  **/
  ...
  public String toString() {
    ...
    if (anonymizerStatus != null) sb.append("    anonymizerStatus: ").append(SENSITIVE_FIELD_PATTERN.matcher("anonymizerStatus").matches() ? "[REDACTED]" : toIndentedString(anonymizerStatus)).append("\n");
    ...
    if (routingMethod != null) sb.append("    routingMethod: ").append(SENSITIVE_FIELD_PATTERN.matcher("routingMethod").matches() ? "[REDACTED]" : toIndentedString(routingMethod)).append("\n");
