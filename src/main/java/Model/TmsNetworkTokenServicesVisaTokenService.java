...
public class TmsNetworkTokenServicesVisaTokenService {
  ...
  **/
  ...
  public String toString() {
    ...
    if (relationshipId != null) sb.append("    relationshipId: ").append(SENSITIVE_FIELD_PATTERN.matcher("relationshipId").matches() ? "[REDACTED]" : toIndentedString(relationshipId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
