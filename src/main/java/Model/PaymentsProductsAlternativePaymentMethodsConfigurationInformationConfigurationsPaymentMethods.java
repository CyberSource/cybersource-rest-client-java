...
public class PaymentsProductsAlternativePaymentMethodsConfigurationInformationConfigurationsPaymentMethods {
  ...
  **/
  ...
  public String toString() {
    ...
    if (logoUrl != null) sb.append("    logoUrl: ").append(SENSITIVE_FIELD_PATTERN.matcher("logoUrl").matches() ? "[REDACTED]" : toIndentedString(logoUrl)).append("\n");
    if (redirectSuccessUrl != null) sb.append("    redirectSuccessUrl: ").append(SENSITIVE_FIELD_PATTERN.matcher("redirectSuccessUrl").matches() ? "[REDACTED]" : toIndentedString(redirectSuccessUrl)).append("\n");
    if (redirectCancelUrl != null) sb.append("    redirectCancelUrl: ").append(SENSITIVE_FIELD_PATTERN.matcher("redirectCancelUrl").matches() ? "[REDACTED]" : toIndentedString(redirectCancelUrl)).append("\n");
    if (redirectFailureUrl != null) sb.append("    redirectFailureUrl: ").append(SENSITIVE_FIELD_PATTERN.matcher("redirectFailureUrl").matches() ? "[REDACTED]" : toIndentedString(redirectFailureUrl)).append("\n");
    ...
    if (additionalConfigurations != null) sb.append("    additionalConfigurations: ").append(SENSITIVE_FIELD_PATTERN.matcher("additionalConfigurations").matches() ? "[REDACTED]" : toIndentedString(additionalConfigurations)).append("\n");
    sb.append("}");
    return sb.toString();
  }
