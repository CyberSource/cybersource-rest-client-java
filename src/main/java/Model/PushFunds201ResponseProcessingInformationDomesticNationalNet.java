...
public class PushFunds201ResponseProcessingInformationDomesticNationalNet {
  ...
  **/
  ...
  public String toString() {
    ...
    if (reimbursementFeeBaseAmount != null) sb.append("    reimbursementFeeBaseAmount: ").append(SENSITIVE_FIELD_PATTERN.matcher("reimbursementFeeBaseAmount").matches() ? "[REDACTED]" : toIndentedString(reimbursementFeeBaseAmount)).append("\n");
    sb.append("}");
    return sb.toString();
  }
