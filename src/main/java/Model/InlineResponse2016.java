...
public class InlineResponse2016 {
  ...
  public InlineResponse2016 webhookId(String webhookId) {
  ...
  **/
  ...
  public InlineResponse2016 organizationId(String organizationId) {
  ...
  **/
  ...
  public InlineResponse2016 products(List<Notificationsubscriptionsv2webhooksProducts> products) {
    this.products = products;
    return this;
  }

  public InlineResponse2016 addProductsItem(Notificationsubscriptionsv2webhooksProducts productsItem) {
  ...
  **/
  ...
  public InlineResponse2016 webhookUrl(String webhookUrl) {
  ...
  **/
  ...
  public InlineResponse2016 healthCheckUrl(String healthCheckUrl) {
  ...
  **/
  ...
  public InlineResponse2016 status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse2016 name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse2016 description(String description) {
  ...
  **/
  ...
  public InlineResponse2016 retryPolicy(Notificationsubscriptionsv2webhooksRetryPolicy retryPolicy) {
  ...
  **/
  ...
  public InlineResponse2016 securityPolicy(Notificationsubscriptionsv2webhooksSecurityPolicy securityPolicy) {
  ...
  **/
  ...
  public InlineResponse2016 createdOn(String createdOn) {
  ...
  **/
  ...
  public InlineResponse2016 notificationScope(String notificationScope) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.webhookId, inlineResponse2016.webhookId) &&
        Objects.equals(this.organizationId, inlineResponse2016.organizationId) &&
        Objects.equals(this.products, inlineResponse2016.products) &&
        Objects.equals(this.webhookUrl, inlineResponse2016.webhookUrl) &&
        Objects.equals(this.healthCheckUrl, inlineResponse2016.healthCheckUrl) &&
        Objects.equals(this.status, inlineResponse2016.status) &&
        Objects.equals(this.name, inlineResponse2016.name) &&
        Objects.equals(this.description, inlineResponse2016.description) &&
        Objects.equals(this.retryPolicy, inlineResponse2016.retryPolicy) &&
        Objects.equals(this.securityPolicy, inlineResponse2016.securityPolicy) &&
        Objects.equals(this.createdOn, inlineResponse2016.createdOn) &&
        Objects.equals(this.notificationScope, inlineResponse2016.notificationScope);
  }
  ...
  public String toString() {
    ...
    if (webhookUrl != null) sb.append("    webhookUrl: ").append(SENSITIVE_FIELD_PATTERN.matcher("webhookUrl").matches() ? "[REDACTED]" : toIndentedString(webhookUrl)).append("\n");
    if (healthCheckUrl != null) sb.append("    healthCheckUrl: ").append(SENSITIVE_FIELD_PATTERN.matcher("healthCheckUrl").matches() ? "[REDACTED]" : toIndentedString(healthCheckUrl)).append("\n");
    ...
    if (retryPolicy != null) sb.append("    retryPolicy: ").append(SENSITIVE_FIELD_PATTERN.matcher("retryPolicy").matches() ? "[REDACTED]" : toIndentedString(retryPolicy)).append("\n");
    if (securityPolicy != null) sb.append("    securityPolicy: ").append(SENSITIVE_FIELD_PATTERN.matcher("securityPolicy").matches() ? "[REDACTED]" : toIndentedString(securityPolicy)).append("\n");
    if (createdOn != null) sb.append("    createdOn: ").append(SENSITIVE_FIELD_PATTERN.matcher("createdOn").matches() ? "[REDACTED]" : toIndentedString(createdOn)).append("\n");
    if (notificationScope != null) sb.append("    notificationScope: ").append(SENSITIVE_FIELD_PATTERN.matcher("notificationScope").matches() ? "[REDACTED]" : toIndentedString(notificationScope)).append("\n");
    sb.append("}");
    return sb.toString();
  }
