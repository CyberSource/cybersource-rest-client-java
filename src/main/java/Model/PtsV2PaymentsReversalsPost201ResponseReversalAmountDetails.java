...
public class PtsV2PaymentsReversalsPost201ResponseReversalAmountDetails {
  ...
  **/
  ...
  public String toString() {
    ...
    if (reversedAmount != null) sb.append("    reversedAmount: ").append(SENSITIVE_FIELD_PATTERN.matcher("reversedAmount").matches() ? "[REDACTED]" : toIndentedString(reversedAmount)).append("\n");
    if (originalTransactionAmount != null) sb.append("    originalTransactionAmount: ").append(SENSITIVE_FIELD_PATTERN.matcher("originalTransactionAmount").matches() ? "[REDACTED]" : toIndentedString(originalTransactionAmount)).append("\n");
