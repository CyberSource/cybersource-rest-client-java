...
public class Ptsv2paymentsPaymentInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (legacyToken != null) sb.append("    legacyToken: ").append(SENSITIVE_FIELD_PATTERN.matcher("legacyToken").matches() ? "[REDACTED]" : toIndentedString(legacyToken)).append("\n");
    ...
    if (initiationChannel != null) sb.append("    initiationChannel: ").append(SENSITIVE_FIELD_PATTERN.matcher("initiationChannel").matches() ? "[REDACTED]" : toIndentedString(initiationChannel)).append("\n");
    if (sepa != null) sb.append("    sepa: ").append(SENSITIVE_FIELD_PATTERN.matcher("sepa").matches() ? "[REDACTED]" : toIndentedString(sepa)).append("\n");
