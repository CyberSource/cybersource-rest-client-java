...
public class PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresent {
  ...
  private Map<String, PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresentProcessors> processors = null;

  @SerializedName("enableTerminalIdLookup")
  private Boolean enableTerminalIdLookup = null;

  public PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresent processors(Map<String, PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresentProcessors> processors) {
  ...
  public PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresent putProcessorsItem(String key, PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresentProcessors processorsItem) {
    if (this.processors == null) {
      this.processors = new HashMap<String, PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresentProcessors>();
    }
  ...
  **/
  ...
  public Map<String, PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresentProcessors> getProcessors() {
    return processors;
  }

  public void setProcessors(Map<String, PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardPresentProcessors> processors) {
    this.processors = processors;
  }
