...
public class Kmsegressv2keysasymKeyInformation {
  ...
  **/
  ...
  public String toString() {
    ...
    if (pub != null) sb.append("    pub: ").append(SENSITIVE_FIELD_PATTERN.matcher("pub").matches() ? "[REDACTED]" : toIndentedString(pub)).append("\n");
    ...
    if (pvt != null) sb.append("    pvt: ").append(SENSITIVE_FIELD_PATTERN.matcher("pvt").matches() ? "[REDACTED]" : toIndentedString(pvt)).append("\n");
