...
public class InvoicingV2InvoicesPost201ResponseMerchantDefinedFieldValuesWithDefinition {
  ...
  **/
  ...
  public String toString() {
    ...
    if (position != null) sb.append("    position: ").append(SENSITIVE_FIELD_PATTERN.matcher("position").matches() ? "[REDACTED]" : toIndentedString(position)).append("\n");
    if (definitionId != null) sb.append("    definitionId: ").append(SENSITIVE_FIELD_PATTERN.matcher("definitionId").matches() ? "[REDACTED]" : toIndentedString(definitionId)).append("\n");
