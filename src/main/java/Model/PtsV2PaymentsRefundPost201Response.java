...
public class PtsV2PaymentsRefundPost201Response {
  ...
  **/
  ...
  public String toString() {
    ...
    if (refundAmountDetails != null) sb.append("    refundAmountDetails: ").append(SENSITIVE_FIELD_PATTERN.matcher("refundAmountDetails").matches() ? "[REDACTED]" : toIndentedString(refundAmountDetails)).append("\n");
