...
public class ChargebackSummariesApi {
    private static Logger logger = LogManager.getLogger(ChargebackSummariesApi.class);
    ...
    private okhttp3.Call getChargebackSummariesValidateBeforeCall(DateTime startTime, DateTime endTime, String organizationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, ConfigException {
        ...
        if (startTime == null) {
            logger.error("Missing the required parameter 'startTime' when calling getChargebackSummaries(Async)");
            throw new ApiException("Missing the required parameter 'startTime' when calling getChargebackSummaries(Async)");
        }
        
        // verify the required parameter 'endTime' is set
        if (endTime == null) {
            logger.error("Missing the required parameter 'endTime' when calling getChargebackSummaries(Async)");
            throw new ApiException("Missing the required parameter 'endTime' when calling getChargebackSummaries(Async)");
        }
        
        
        okhttp3.Call call = getChargebackSummariesCall(startTime, endTime, organizationId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ReportingV3ChargebackSummariesGet200Response> getChargebackSummariesWithHttpInfo(DateTime startTime, DateTime endTime, String organizationId) throws ApiException, ConfigException {
     ...
     */
    public okhttp3.Call getChargebackSummariesAsync(DateTime startTime, DateTime endTime, String organizationId, final ApiCallback<ReportingV3ChargebackSummariesGet200Response> callback) throws ApiException, ConfigException {
        ...
        okhttp3.Call call = getChargebackSummariesValidateBeforeCall(startTime, endTime, organizationId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ReportingV3ChargebackSummariesGet200Response>(){}.getType();
