...
import Model.ReportingV3InterchangeClearingLevelDetailsGet200Response;
...
public class InterchangeClearingLevelDetailsApi {
    private static Logger logger = LogManager.getLogger(InterchangeClearingLevelDetailsApi.class);
    ...
    private okhttp3.Call getInterchangeClearingLevelDetailsValidateBeforeCall(DateTime startTime, DateTime endTime, String organizationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (startTime == null) {
            logger.error("Missing the required parameter 'startTime' when calling getInterchangeClearingLevelDetails(Async)");
            throw new ApiException("Missing the required parameter 'startTime' when calling getInterchangeClearingLevelDetails(Async)");
        }
        
        // verify the required parameter 'endTime' is set
        if (endTime == null) {
            logger.error("Missing the required parameter 'endTime' when calling getInterchangeClearingLevelDetails(Async)");
            throw new ApiException("Missing the required parameter 'endTime' when calling getInterchangeClearingLevelDetails(Async)");
        }
        
        
        okhttp3.Call call = getInterchangeClearingLevelDetailsCall(startTime, endTime, organizationId, progressListener, progressRequestListener);
        return call;
    ...
    public okhttp3.Call getInterchangeClearingLevelDetailsAsync(DateTime startTime, DateTime endTime, String organizationId, final ApiCallback<ReportingV3InterchangeClearingLevelDetailsGet200Response> callback) throws ApiException {
        ...
        okhttp3.Call call = getInterchangeClearingLevelDetailsValidateBeforeCall(startTime, endTime, organizationId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ReportingV3InterchangeClearingLevelDetailsGet200Response>(){}.getType();
