...
import Model.BinLookup403Response;
...
public class BinLookupApi {
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public InlineResponse2013 getAccountInfo(CreateBinLookupRequest createBinLookupRequest) throws ApiException, ConfigException {
        logger.info("CALL TO METHOD 'getAccountInfo' STARTED");
        ApiResponse<InlineResponse2013> resp = getAccountInfoWithHttpInfo(createBinLookupRequest);
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public ApiResponse<InlineResponse2013> getAccountInfoWithHttpInfo(CreateBinLookupRequest createBinLookupRequest) throws ApiException, ConfigException {
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public okhttp3.Call getAccountInfoAsync(CreateBinLookupRequest createBinLookupRequest, final ApiCallback<InlineResponse2013> callback) throws ApiException, ConfigException {
