...
public class BinLookupApi {
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public InlineResponse2016 getAccountInfo(CreateBinLookupRequest createBinLookupRequest) throws ApiException, ConfigException {
        logger.info("CALL TO METHOD 'getAccountInfo' STARTED");
        ApiResponse<InlineResponse2016> resp = getAccountInfoWithHttpInfo(createBinLookupRequest);
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public ApiResponse<InlineResponse2016> getAccountInfoWithHttpInfo(CreateBinLookupRequest createBinLookupRequest) throws ApiException, ConfigException {
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public okhttp3.Call getAccountInfoAsync(CreateBinLookupRequest createBinLookupRequest, final ApiCallback<InlineResponse2016> callback) throws ApiException, ConfigException {
