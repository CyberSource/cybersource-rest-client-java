...
public class TransactionDetailsApi {
     ...
     */
    public InlineResponse20012 getTransaction(String id, MerchantConfig merchantConfig) throws ApiException {
        ApiResponse<InlineResponse20012> resp = getTransactionWithHttpInfo(id,  merchantConfig);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse20012> getTransactionWithHttpInfo(String id, MerchantConfig merchantConfig) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getTransactionAsync(String id,  MerchantConfig merchantConfig,final ApiCallback<InlineResponse20012> callback) throws ApiException {
