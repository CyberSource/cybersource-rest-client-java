...
public class DecisionManagerApi {
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public InlineResponse2003 actionDecisionManagerCase(String id, CaseManagementActionsRequest caseManagementActionsRequest) throws ApiException, ConfigException {
        logger.info("CALL TO METHOD 'actionDecisionManagerCase' STARTED");
        ApiResponse<InlineResponse2003> resp = actionDecisionManagerCaseWithHttpInfo(id, caseManagementActionsRequest);
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public ApiResponse<InlineResponse2003> actionDecisionManagerCaseWithHttpInfo(String id, CaseManagementActionsRequest caseManagementActionsRequest) throws ApiException, ConfigException {
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public okhttp3.Call actionDecisionManagerCaseAsync(String id, CaseManagementActionsRequest caseManagementActionsRequest, final ApiCallback<InlineResponse2003> callback) throws ApiException, ConfigException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call addNegativeValidateBeforeCall(String type, AddNegativeListRequest addNegativeListRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, ConfigException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call commentDecisionManagerCaseValidateBeforeCall(String id, CaseManagementCommentsRequest caseManagementCommentsRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, ConfigException {
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public InlineResponse2012 commentDecisionManagerCase(String id, CaseManagementCommentsRequest caseManagementCommentsRequest) throws ApiException, ConfigException {
        logger.info("CALL TO METHOD 'commentDecisionManagerCase' STARTED");
        ApiResponse<InlineResponse2012> resp = commentDecisionManagerCaseWithHttpInfo(id, caseManagementCommentsRequest);
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public ApiResponse<InlineResponse2012> commentDecisionManagerCaseWithHttpInfo(String id, CaseManagementCommentsRequest caseManagementCommentsRequest) throws ApiException, ConfigException {
        this.apiClient.setComputationStartTime(System.nanoTime());
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public okhttp3.Call commentDecisionManagerCaseAsync(String id, CaseManagementCommentsRequest caseManagementCommentsRequest, final ApiCallback<InlineResponse2012> callback) throws ApiException, ConfigException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fraudUpdateValidateBeforeCall(String id, FraudMarkingActionRequest fraudMarkingActionRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, ConfigException {
