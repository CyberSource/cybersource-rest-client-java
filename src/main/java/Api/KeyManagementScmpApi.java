...
public class KeyManagementScmpApi {
    ...
    private okhttp3.Call updateSCMPValidateBeforeCall(String keyId, UpdatePGPKeysRequest1 updatePGPKeysRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        okhttp3.Call call = updateSCMPCall(keyId, updatePGPKeysRequest, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> updateSCMPWithHttpInfo(String keyId, UpdatePGPKeysRequest1 updatePGPKeysRequest) throws ApiException {
        okhttp3.Call call = updateSCMPValidateBeforeCall(keyId, updatePGPKeysRequest, null, null);
     ...
     */
    public okhttp3.Call updateSCMPAsync(String keyId, UpdatePGPKeysRequest1 updatePGPKeysRequest, final ApiCallback<Object> callback) throws ApiException {
        ...
        okhttp3.Call call = updateSCMPValidateBeforeCall(keyId, updatePGPKeysRequest, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
