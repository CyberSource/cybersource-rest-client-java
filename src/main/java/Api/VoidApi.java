...
public class VoidApi {
     ...
     */
    public com.squareup.okhttp.Call mitVoidCall(MitVoidRequest mitVoidRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
...
final String[] localVarAccepts = {"application/hal+json;charset=utf-8"};
    ...
    private com.squareup.okhttp.Call mitVoidValidateBeforeCall(MitVoidRequest mitVoidRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = mitVoidCall(mitVoidRequest, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<PtsV2PaymentsVoidsPost201Response> mitVoidWithHttpInfo(MitVoidRequest mitVoidRequest) throws ApiException {
        com.squareup.okhttp.Call call = mitVoidValidateBeforeCall(mitVoidRequest, null, null);
     ...
     */
    public com.squareup.okhttp.Call mitVoidAsync(MitVoidRequest mitVoidRequest, final ApiCallback<PtsV2PaymentsVoidsPost201Response> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = mitVoidValidateBeforeCall(mitVoidRequest, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PtsV2PaymentsVoidsPost201Response>(){}.getType();
