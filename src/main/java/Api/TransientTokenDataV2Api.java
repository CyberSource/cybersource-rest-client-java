...
public class TransientTokenDataV2Api {
    private static Logger logger = LogManager.getLogger(TransientTokenDataV2Api.class);
     ...
     * @param jti The jti within the Transient Token jwt returned by the Unified Checkout application  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public okhttp3.Call getTransactionForTransientTokenJTICall(String jti, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, ConfigException {
        SdkTracker sdkTracker = new SdkTracker();
        Object localVarPostBody = null;
        if ("GET".equalsIgnoreCase("POST")) {
            localVarPostBody = "{}";
        ...
        if (MLEUtility.checkIsMLEForAPI(apiClient.merchantConfig, inboundMLEStatus, "getTransactionForTransientTokenJTI,getTransactionForTransientTokenJTIAsync,getTransactionForTransientTokenJTIWithHttpInfo,getTransactionForTransientTokenJTICall")) {
            try {
                localVarPostBody = MLEUtility.encryptRequestPayload(apiClient.merchantConfig, localVarPostBody);
            } catch (MLEException e) {
                logger.error("Failed to encrypt request body {}", e.getMessage(), e);
        ...
        boolean isResponseMLEForApi = MLEUtility.checkIsResponseMLEForAPI(apiClient.merchantConfig, "getTransactionForTransientTokenJTI,getTransactionForTransientTokenJTIAsync,getTransactionForTransientTokenJTIWithHttpInfo,getTransactionForTransientTokenJTICall");
        
        // create path and map variables
        String localVarPath = "/flex/v2/payment-details/{jti}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTransactionForTransientTokenJTIValidateBeforeCall(String jti, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, ConfigException {
        
        // verify the required parameter 'jti' is set
        if (jti == null) {
            logger.error("Missing the required parameter 'jti' when calling getTransactionForTransientTokenJTI(Async)");
            throw new ApiException("Missing the required parameter 'jti' when calling getTransactionForTransientTokenJTI(Async)");
        }
        
        
        okhttp3.Call call = getTransactionForTransientTokenJTICall(jti, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public void getTransactionForTransientTokenJTI(String jti) throws ApiException, ConfigException {
        logger.info("CALL TO METHOD 'getTransactionForTransientTokenJTI' STARTED");
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public ApiResponse<Void> getTransactionForTransientTokenJTIWithHttpInfo(String jti) throws ApiException, ConfigException {
        this.apiClient.setComputationStartTime(System.nanoTime());
        okhttp3.Call call = getTransactionForTransientTokenJTIValidateBeforeCall(jti, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ConfigException If creation of merchant configuration fails in ApiClient
     */
    public okhttp3.Call getTransactionForTransientTokenJTIAsync(String jti, final ApiCallback<Void> callback) throws ApiException, ConfigException {
        ...
        okhttp3.Call call = getTransactionForTransientTokenJTIValidateBeforeCall(jti, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
