...
public class DeviceDeAssociationV3Api {
    private static Logger logger = LogManager.getLogger(DeviceDeAssociationV3Api.class);
    
    private ApiClient apiClient;

    public DeviceDeAssociationV3Api() {
        this(Configuration.getDefaultApiClient());
    }

    public DeviceDeAssociationV3Api(ApiClient apiClient) {
     ...
     */
    public List<InlineResponse2005> postDeAssociateV3Terminal(List<DeviceDeAssociateV3Request> deviceDeAssociateV3Request) throws ApiException {
        logger.info("CALL TO METHOD 'postDeAssociateV3Terminal' STARTED");
        ApiResponse<List<InlineResponse2005>> resp = postDeAssociateV3TerminalWithHttpInfo(deviceDeAssociateV3Request);
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<InlineResponse2005>> postDeAssociateV3TerminalWithHttpInfo(List<DeviceDeAssociateV3Request> deviceDeAssociateV3Request) throws ApiException {
    ...
    /**
     * De-associate a device from merchant to account or reseller and from account to reseller V3 (asynchronously)
     * A device will be de-associated from its current organization and moved up in the hierarchy. The device&#39;s new position will be determined by a specified destination, either an account or a portfolio. If no destination is provided, the device will default to the currently logged-in user. 
     * @param deviceDeAssociateV3Request deviceId that has to be de-associated to the destination organizationId. (required)
     ...
     */
    public okhttp3.Call postDeAssociateV3TerminalAsync(List<DeviceDeAssociateV3Request> deviceDeAssociateV3Request, final ApiCallback<List<InlineResponse2005>> callback) throws ApiException {
