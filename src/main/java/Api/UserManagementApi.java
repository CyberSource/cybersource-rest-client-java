...
public class UserManagementApi {
    ...
    public okhttp3.Call getUsersCall(String organizationId, String userName, String permissionId, String roleId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (MLEUtility.checkIsMLEForAPI(apiClient.merchantConfig, inboundMLEStatus, "getUsers,getUsersAsync,getUsersWithHttpInfo,getUsersCall")) {
            try {
        ...
        boolean isResponseMLEForApi = MLEUtility.checkIsResponseMLEForAPI(apiClient.merchantConfig, "getUsers,getUsersAsync,getUsersWithHttpInfo,getUsersCall");
