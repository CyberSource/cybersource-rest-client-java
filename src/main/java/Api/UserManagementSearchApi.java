...
public class UserManagementSearchApi {
    ...
    public okhttp3.Call searchUsersCall(SearchRequest searchRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (MLEUtility.checkIsMLEForAPI(apiClient.merchantConfig, inboundMLEStatus, "searchUsers,searchUsersAsync,searchUsersWithHttpInfo,searchUsersCall")) {
            try {
        ...
        boolean isResponseMLEForApi = MLEUtility.checkIsResponseMLEForAPI(apiClient.merchantConfig, "searchUsers,searchUsersAsync,searchUsersWithHttpInfo,searchUsersCall");
